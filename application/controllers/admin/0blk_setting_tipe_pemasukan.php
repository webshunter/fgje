...
class 0blk_setting_tipe_pemasukan extends CI_Controller {

	private $table1 = '0blk_setting_tipe_pemasukan';
	...
	{
        $this->Createtable->location('admin/0blk_setting_tipe_pemasukan/table_show');
        ...
        $this->load->view('admin/0blk_setting_tipe_pemasukan/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/0blk_setting_tipe_pemasukan/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/0blk_setting_tipe_pemasukan/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$ip_created = post("ip_created");
        ...
        $simpan = $this->db->query("
            INSERT INTO 0blk_setting_tipe_pemasukan
        ...
        if($simpan){
            redirect('admin/0blk_setting_tipe_pemasukan');
        }
    }
...
$ip_created = post("ip_created");
        ...
        $simpan = $this->db->query("
            UPDATE 0blk_setting_tipe_pemasukan SET  id_tipe_pemasukan = '$id_tipe_pemasukan', nama_tipe_pemasukan = '$nama_tipe_pemasukan', pemilik_option = '$pemilik_option', user_created_id = '$user_created_id', tanggal_created = '$tanggal_created', jam_created = '$jam_created', ip_created = '$ip_created' WHERE  = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-0blk_setting_tipe_pemasukan.xlsx')
    {
