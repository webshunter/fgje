...
class 0blk_setting_tipe_pengeluaran extends CI_Controller {

	private $table1 = '0blk_setting_tipe_pengeluaran';
	...
	{
        $this->Createtable->location('admin/0blk_setting_tipe_pengeluaran/table_show');
        ...
        $this->load->view('admin/0blk_setting_tipe_pengeluaran/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/0blk_setting_tipe_pengeluaran/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/0blk_setting_tipe_pengeluaran/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$ip_created = post("ip_created");
        ...
        $simpan = $this->db->query("
            INSERT INTO 0blk_setting_tipe_pengeluaran
        ...
        if($simpan){
            redirect('admin/0blk_setting_tipe_pengeluaran');
        }
    }
...
$ip_created = post("ip_created");
        ...
        $simpan = $this->db->query("
            UPDATE 0blk_setting_tipe_pengeluaran SET  id_tipe_pengeluaran = '$id_tipe_pengeluaran', nama_tipe_pengeluaran = '$nama_tipe_pengeluaran', user_created_id = '$user_created_id', tanggal_created = '$tanggal_created', jam_created = '$jam_created', ip_created = '$ip_created' WHERE  = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-0blk_setting_tipe_pengeluaran.xlsx')
    {
