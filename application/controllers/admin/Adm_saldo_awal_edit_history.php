...
class Adm_saldo_awal_edit_history extends CI_Controller {

	private $table1 = 'adm_saldo_awal_edit_history';
	...
	{
        $this->Createtable->location('admin/adm_saldo_awal_edit_history/table_show');
        ...
        $this->load->view('admin/adm_saldo_awal_edit_history/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/adm_saldo_awal_edit_history/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/adm_saldo_awal_edit_history/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$adm_saldo_awal_id = post("adm_saldo_awal_id");
        ...
        $simpan = $this->db->query("
            INSERT INTO adm_saldo_awal_edit_history
        ...
        if($simpan){
            redirect('admin/adm_saldo_awal_edit_history');
        }
    }
...
$adm_saldo_awal_id = post("adm_saldo_awal_id");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-adm_saldo_awal_edit_history.xlsx')
    {
