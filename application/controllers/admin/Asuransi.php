...
class Asuransi extends CI_Controller {
	...
	{
        $this->Createtable->location('admin/asuransi/table_show');
        ...
        $this->load->view('admin/asuransi/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/asuransi/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/asuransi/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$jumlah = post("jumlah");
        ...
        $simpan = $this->db->query("
            UPDATE asuransi SET  id_biodata = '$id_biodata', noasuransi = '$noasuransi', namaasuransi = '$namaasuransi', tglasuransi = '$tglasuransi', jumlah = '$jumlah' WHERE id_asuransi = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-asuransi.xlsx')
    {
