...
class Blk_data_pemasukan_copy extends CI_Controller {

	private $table1 = 'blk_data_pemasukan_copy';
	...
	{
        $this->Createtable->location('admin/blk_data_pemasukan_copy/table_show');
        ...
        $this->load->view('admin/blk_data_pemasukan_copy/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/blk_data_pemasukan_copy/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/blk_data_pemasukan_copy/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$keterangan = post("keterangan");
        ...
        $simpan = $this->db->query("
            INSERT INTO blk_data_pemasukan_copy
        ...
        if($simpan){
            redirect('admin/blk_data_pemasukan_copy');
        }
    }
...
$keterangan = post("keterangan");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-blk_data_pemasukan_copy.xlsx')
    {
