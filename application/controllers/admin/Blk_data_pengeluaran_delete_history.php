...
class Blk_data_pengeluaran_delete_history extends CI_Controller {

	private $table1 = 'blk_data_pengeluaran_delete_history';
	...
	{
        $this->Createtable->location('admin/blk_data_pengeluaran_delete_history/table_show');
        ...
        $this->load->view('admin/blk_data_pengeluaran_delete_history/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/blk_data_pengeluaran_delete_history/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/blk_data_pengeluaran_delete_history/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$keterangan = post("keterangan");
        ...
        $simpan = $this->db->query("
            INSERT INTO blk_data_pengeluaran_delete_history
        ...
        if($simpan){
            redirect('admin/blk_data_pengeluaran_delete_history');
        }
    }
...
$keterangan = post("keterangan");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-blk_data_pengeluaran_delete_history.xlsx')
    {
