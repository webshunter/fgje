...
class Blk_jadwalmateri_jompo extends CI_Controller {

	private $table1 = 'blk_jadwalmateri_jompo';
	...
	{
        $this->Createtable->location('admin/blk_jadwalmateri_jompo/table_show');
        ...
        $this->load->view('admin/blk_jadwalmateri_jompo/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/blk_jadwalmateri_jompo/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/blk_jadwalmateri_jompo/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$kode_detail = post("kode_detail");
        ...
        $simpan = $this->db->query("
            UPDATE blk_jadwalmateri_jompo SET  materi_id = '$materi_id', instruktur_id = '$instruktur_id', jam_id = '$jam_id', kode_jadwal = '$kode_jadwal', kode_detail = '$kode_detail' WHERE id_blk_jadwalmateri = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-blk_jadwalmateri_jompo.xlsx')
    {
