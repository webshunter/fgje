...
class Blk_jadwaltki_jompo extends CI_Controller {

	private $table1 = 'blk_jadwaltki_jompo';
	...
	{
        $this->Createtable->location('admin/blk_jadwaltki_jompo/table_show');
        ...
        $this->load->view('admin/blk_jadwaltki_jompo/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/blk_jadwaltki_jompo/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/blk_jadwaltki_jompo/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$kode_detail = post("kode_detail");
        ...
        $simpan = $this->db->query("
            UPDATE blk_jadwaltki_jompo SET  nodaftar = '$nodaftar', kode_jadwal = '$kode_jadwal', kode_detail = '$kode_detail' WHERE id_jadwaltki = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-blk_jadwaltki_jompo.xlsx')
    {
