...
class Blk_no_ranjang_history_copy extends CI_Controller {

	private $table1 = 'blk_no_ranjang_history_copy';
	...
	{
        $this->Createtable->location('admin/blk_no_ranjang_history_copy/table_show');
        ...
        $this->load->view('admin/blk_no_ranjang_history_copy/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/blk_no_ranjang_history_copy/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/blk_no_ranjang_history_copy/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$tanggal_selesai = post("tanggal_selesai");
        ...
        $simpan = $this->db->query("
            UPDATE blk_no_ranjang_history_copy SET  nodaftar = '$nodaftar', ranjangno = '$ranjangno', tanggal_mulai = '$tanggal_mulai', tanggal_selesai = '$tanggal_selesai' WHERE id_history = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-blk_no_ranjang_history_copy.xlsx')
    {
