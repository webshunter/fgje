...
class Blk_pelajaran_graha_laundry extends CI_Controller {

	private $table1 = 'blk_pelajaran_graha_laundry';
	...
	{
        $this->Createtable->location('admin/blk_pelajaran_graha_laundry/table_show');
        ...
        $this->load->view('admin/blk_pelajaran_graha_laundry/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/blk_pelajaran_graha_laundry/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/blk_pelajaran_graha_laundry/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$tipe_input = post("tipe_input");
        ...
        $simpan = $this->db->query("
            INSERT INTO blk_pelajaran_graha_laundry
        ...
        if($simpan){
            redirect('admin/blk_pelajaran_graha_laundry');
        }
    }

    public function update(){
          $key = post('id_graha_laundry'); $kode_materi = post("kode_materi");
$nama_materi = post("nama_materi");
$buku_hal = post("buku_hal");
$penjelasan = post("penjelasan");
$keterangan = post("keterangan");
$tipe_input = post("tipe_input");
        ...
        $simpan = $this->db->query("
            UPDATE blk_pelajaran_graha_laundry SET  kode_materi = '$kode_materi', nama_materi = '$nama_materi', buku_hal = '$buku_hal', penjelasan = '$penjelasan', keterangan = '$keterangan', tipe_input = '$tipe_input' WHERE id_graha_laundry = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-blk_pelajaran_graha_laundry.xlsx')
    {
