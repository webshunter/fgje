...
class Blk_pelajaran_graha_ruang extends CI_Controller {

	private $table1 = 'blk_pelajaran_graha_ruang';
	...
	{
        $this->Createtable->location('admin/blk_pelajaran_graha_ruang/table_show');
        ...
        $this->load->view('admin/blk_pelajaran_graha_ruang/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/blk_pelajaran_graha_ruang/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/blk_pelajaran_graha_ruang/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$tipe_input = post("tipe_input");
        ...
        $simpan = $this->db->query("
            INSERT INTO blk_pelajaran_graha_ruang
        ...
        if($simpan){
            redirect('admin/blk_pelajaran_graha_ruang');
        }
    }
...
$tipe_input = post("tipe_input");
        ...
        $simpan = $this->db->query("
            UPDATE blk_pelajaran_graha_ruang SET  kode_materi = '$kode_materi', nama_materi = '$nama_materi', buku_hal = '$buku_hal', penjelasan = '$penjelasan', keterangan = '$keterangan', tipe_input = '$tipe_input' WHERE id_graha_ruang = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-blk_pelajaran_graha_ruang.xlsx')
    {
