...
class Blk_pelatihan_graha_laundry extends CI_Controller {

	private $table1 = 'blk_pelatihan_graha_laundry';
	...
	{
        $this->Createtable->location('admin/blk_pelatihan_graha_laundry/table_show');
        ...
        $this->load->view('admin/blk_pelatihan_graha_laundry/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/blk_pelatihan_graha_laundry/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/blk_pelatihan_graha_laundry/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$keterangan = post("keterangan");
        ...
        $simpan = $this->db->query("
            UPDATE blk_pelatihan_graha_laundry SET  kode_materi = '$kode_materi', nama_materi = '$nama_materi', buku_hal = '$buku_hal', penjelasan = '$penjelasan', keterangan = '$keterangan' WHERE id_graha_laundry = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-blk_pelatihan_graha_laundry.xlsx')
    {
