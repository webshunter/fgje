...
class Data_pemasukan_edit_history extends CI_Controller {

	private $table1 = 'data_pemasukan_edit_history';
	...
	{
        $this->Createtable->location('admin/data_pemasukan_edit_history/table_show');
        ...
        $this->load->view('admin/data_pemasukan_edit_history/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/data_pemasukan_edit_history/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/data_pemasukan_edit_history/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$keterangan = post("keterangan");
        ...
        $simpan = $this->db->query("
            INSERT INTO data_pemasukan_edit_history
        ...
        if($simpan){
            redirect('admin/data_pemasukan_edit_history');
        }
    }
...
$keterangan = post("keterangan");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-data_pemasukan_edit_history.xlsx')
    {
