...
class Dataagen_fee_tki_terbang extends CI_Controller {

	private $table1 = 'dataagen_fee_tki_terbang';
	...
	{
        $this->Createtable->location('admin/dataagen_fee_tki_terbang/table_show');
        ...
        $this->load->view('admin/dataagen_fee_tki_terbang/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/dataagen_fee_tki_terbang/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/dataagen_fee_tki_terbang/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$deleted_at = post("deleted_at");
        ...
        $simpan = $this->db->query("
            INSERT INTO dataagen_fee_tki_terbang
        ...
        if($simpan){
            redirect('admin/dataagen_fee_tki_terbang');
        }
    }
...
$deleted_at = post("deleted_at");
        ...
        $simpan = $this->db->query("
            UPDATE dataagen_fee_tki_terbang SET  tgl1 = '$tgl1', tgl2 = '$tgl2', catatan = '$catatan', tgl_transfer = '$tgl_transfer', pilihan = '$pilihan', group = '$group', agen = '$agen', jenis_tki = '$jenis_tki', data = '$data', agen_list = '$agen_list', date_created = '$date_created', deleted_at = '$deleted_at' WHERE id = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-dataagen_fee_tki_terbang.xlsx')
    {
