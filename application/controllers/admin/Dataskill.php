...
class Dataskill extends CI_Controller {

	private $table1 = 'dataskill';
	...
	{
        $this->Createtable->location('admin/dataskill/table_show');
        ...
        $this->load->view('admin/dataskill/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/dataskill/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/dataskill/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$keterangan = post("keterangan");
        ...
        $simpan = $this->db->query("
            INSERT INTO dataskill
            (id_kategori,isi,mandarin,keterangan) VALUES ('$id_kategori','$isi','$mandarin','$keterangan')
        ");
    

        if($simpan){
            redirect('admin/dataskill');
        }
    }

    public function update(){
          $key = post('id_skill'); $id_kategori = post("id_kategori");
$isi = post("isi");
$mandarin = post("mandarin");
$keterangan = post("keterangan");

        $simpan = $this->db->query("
            UPDATE dataskill SET  id_kategori = '$id_kategori', isi = '$isi', mandarin = '$mandarin', keterangan = '$keterangan' WHERE id_skill = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-dataskill.xlsx')
    {
