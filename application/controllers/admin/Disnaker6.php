...
class Disnaker6 extends CI_Controller {

	private $table1 = 'disnaker6';
	...
	{
        $this->Createtable->location('admin/disnaker6/table_show');
        ...
        $this->load->view('admin/disnaker6/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/disnaker6/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/disnaker6/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$alamatortu = post("alamatortu");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-disnaker6.xlsx')
    {
