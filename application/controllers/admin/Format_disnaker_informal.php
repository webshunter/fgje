...
class Format_disnaker_informal extends CI_Controller {

	private $table1 = 'format_disnaker_informal';
	...
	{
        $this->Createtable->location('admin/format_disnaker_informal/table_show');
        ...
        $this->load->view('admin/format_disnaker_informal/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/format_disnaker_informal/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/format_disnaker_informal/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$mata_uang = post("mata_uang");
        ...
        $simpan = $this->db->query("
            INSERT INTO format_disnaker_informal
        ...
        if($simpan){
            redirect('admin/format_disnaker_informal');
        }
    }
...
$mata_uang = post("mata_uang");
        ...
        $simpan = $this->db->query("
            UPDATE format_disnaker_informal SET  id_biodata = '$id_biodata', jabatan = '$jabatan', no_ktpnya = '$no_ktpnya', tgl_berangkatnya = '$tgl_berangkatnya', tgl_tibanya = '$tgl_tibanya', gajinya = '$gajinya', mata_uang = '$mata_uang' WHERE id_karep = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-format_disnaker_informal.xlsx')
    {
