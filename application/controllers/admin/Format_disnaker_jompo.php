...
class Format_disnaker_jompo extends CI_Controller {

	private $table1 = 'format_disnaker_jompo';
	...
	{
        $this->Createtable->location('admin/format_disnaker_jompo/table_show');
        ...
        $this->load->view('admin/format_disnaker_jompo/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/format_disnaker_jompo/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/format_disnaker_jompo/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$mata_uang = post("mata_uang");
        ...
        $simpan = $this->db->query("
            INSERT INTO format_disnaker_jompo
        ...
        if($simpan){
            redirect('admin/format_disnaker_jompo');
        }
    }
...
$mata_uang = post("mata_uang");
        ...
        $simpan = $this->db->query("
            UPDATE format_disnaker_jompo SET  id_biodata = '$id_biodata', jabatan = '$jabatan', no_ktpnya = '$no_ktpnya', tgl_berangkatnya = '$tgl_berangkatnya', tgl_tibanya = '$tgl_tibanya', gajinya = '$gajinya', mata_uang = '$mata_uang' WHERE id_karep = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-format_disnaker_jompo.xlsx')
    {
