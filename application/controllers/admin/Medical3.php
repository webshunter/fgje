...
class Medical3 extends CI_Controller {

	private $table1 = 'medical3';
	...
	{
        $this->Createtable->location('admin/medical3/table_show');
        ...
        $this->load->view('admin/medical3/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/medical3/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/medical3/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$tanggalmedid = post("tanggalmedid");
        ...
        $simpan = $this->db->query("
            UPDATE medical3 SET  id_biodata = '$id_biodata', nama = '$nama', nomor = '$nomor', keterangan = '$keterangan', jenismedical = '$jenismedical', expired = '$expired', tanggal = '$tanggal', tglsidik = '$tglsidik', status = '$status', catatan = '$catatan', nomedical = '$nomedical', namamedical = '$namamedical', tanggalmedid = '$tanggalmedid' WHERE id_medical = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-medical3.xlsx')
    {
