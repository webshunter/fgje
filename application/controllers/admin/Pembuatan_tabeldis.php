...
class Pembuatan_tabeldis extends CI_Controller {

	private $table1 = 'pembuatan_tabeldis';
	...
	{
        $this->Createtable->location('admin/pembuatan_tabeldis/table_show');
        ...
        $this->load->view('admin/pembuatan_tabeldis/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/pembuatan_tabeldis/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/pembuatan_tabeldis/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$asuransi = post("asuransi");
        ...
        $simpan = $this->db->query("
            UPDATE pembuatan_tabeldis SET  daerah = '$daerah', tanggal = '$tanggal', biaya = '$biaya', asuransi = '$asuransi' WHERE id_pembuatan = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-pembuatan_tabeldis.xlsx')
    {
