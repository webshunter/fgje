...
class Personal_BACKUP extends CI_Controller {

	private $table1 = 'personal_BACKUP';
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/personal_BACKUP/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/personal_BACKUP/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$ketadm = post("ketadm");
        ...
        $simpan = $this->db->query("
            ...
            (id_biodata,negara1,negara2,calling,skill1,skill2,skill3,kode_proses,kode_sponsor,kode_agen,nama,nama_mandarin,jeniskelamin,notelp,notelpkel,tanggaldaftar,tinggi,berat,hp,hpkel,warganegara,tempatlahir,tgllahir,agama,status,tglmenikah,pendidikan,alamat,alamatlengkap,provinsi,mandarin,taiyu,inggris,cantonese,hakka,foto,statusaktif,indukagen,kirimbio,pk,pap,remark,datafoto,keterangan,lokasikerja,idpemilik,statterbang,ketdok,ketadm) VALUES ('$id_biodata','$negara1','$negara2','$calling','$skill1','$skill2','$skill3','$kode_proses','$kode_sponsor','$kode_agen','$nama','$nama_mandarin','$jeniskelamin','$notelp','$notelpkel','$tanggaldaftar','$tinggi','$berat','$hp','$hpkel','$warganegara','$tempatlahir','$tgllahir','$agama','$status','$tglmenikah','$pendidikan','$alamat','$alamatlengkap','$provinsi','$mandarin','$taiyu','$inggris','$cantonese','$hakka','$foto','$statusaktif','$indukagen','$kirimbio','$pk','$pap','$remark','$datafoto','$keterangan','$lokasikerja','$idpemilik','$statterbang','$ketdok','$ketadm')
        ");
    

        if($simpan){
            redirect('admin/personal_BACKUP');
        }
    }
...
$ketadm = post("ketadm");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-personal_BACKUP.xlsx')
    {
