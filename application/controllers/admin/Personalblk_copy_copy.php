...
class Personalblk_copy_copy extends CI_Controller {

	private $table1 = 'personalblk_copy_copy';
	...
	{
        $this->Createtable->location('admin/personalblk_copy_copy/table_show');
        ...
        $this->load->view('admin/personalblk_copy_copy/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/personalblk_copy_copy/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/personalblk_copy_copy/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$sektor_tki = post("sektor_tki");
        ...
        $simpan = $this->db->query("
            INSERT INTO personalblk_copy_copy
        ...
        if($simpan){
            redirect('admin/personalblk_copy_copy');
        }
    }
...
$sektor_tki = post("sektor_tki");
        ...
        $simpan = $this->db->query("
            UPDATE personalblk_copy_copy SET  pemilik = '$pemilik', nodaftar = '$nodaftar', nama = '$nama', sponsor = '$sponsor', nodisnaker = '$nodisnaker', tempatlahir = '$tempatlahir', tanggallahir = '$tanggallahir', jeniskelamin = '$jeniskelamin', alamat = '$alamat', notelp = '$notelp', pendidikan = '$pendidikan', noktp = '$noktp', negara = '$negara', bahasa = '$bahasa', eksnon = '$eksnon', cluster = '$cluster', nopaspor = '$nopaspor', tglmedawal = '$tglmedawal', tglmedfull = '$tglmedfull', tglsidikjari = '$tglsidikjari', adm_tglreg = '$adm_tglreg', foto = '$foto', cektgl = '$cektgl', cekins = '$cekins', cekket = '$cekket', ranjangtgl = '$ranjangtgl', ranjangno = '$ranjangno', statujk = '$statujk', statterbang = '$statterbang', sektor_tki = '$sektor_tki' WHERE id_personalblk = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-personalblk_copy_copy.xlsx')
    {
