...
class Setting_tipe_pemasukan_pajak extends CI_Controller {

	private $table1 = 'setting_tipe_pemasukan_pajak';
	...
	{
        $this->Createtable->location('admin/setting_tipe_pemasukan_pajak/table_show');
        ...
        $this->load->view('admin/setting_tipe_pemasukan_pajak/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/setting_tipe_pemasukan_pajak/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/setting_tipe_pemasukan_pajak/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$ip_created = post("ip_created");
        ...
        $simpan = $this->db->query("
            INSERT INTO setting_tipe_pemasukan_pajak
        ...
        if($simpan){
            redirect('admin/setting_tipe_pemasukan_pajak');
        }
    }
...
$ip_created = post("ip_created");
        ...
        $simpan = $this->db->query("
            UPDATE setting_tipe_pemasukan_pajak SET  id_tipe_pemasukan = '$id_tipe_pemasukan', nama_tipe_pemasukan = '$nama_tipe_pemasukan', pemilik_option = '$pemilik_option', user_created_id = '$user_created_id', tanggal_created = '$tanggal_created', jam_created = '$jam_created', ip_created = '$ip_created' WHERE  = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-setting_tipe_pemasukan_pajak.xlsx')
    {
