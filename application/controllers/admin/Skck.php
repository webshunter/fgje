...
class Skck extends CI_Controller {
	...
	{
        $this->Createtable->location('admin/skck/table_show');
        ...
        $this->load->view('admin/skck/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/skck/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/skck/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$statusexp = post("statusexp");
        ...
        $simpan = $this->db->query("
            UPDATE skck SET  id_biodata = '$id_biodata', namaskck = '$namaskck', pengajuan = '$pengajuan', terima = '$terima', tglexp = '$tglexp', statuspengajuan = '$statuspengajuan', statusterima = '$statusterima', statusexp = '$statusexp' WHERE id_skck = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-skck.xlsx')
    {
