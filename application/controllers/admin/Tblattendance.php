...
class Tblattendance extends CI_Controller {

	private $table1 = 'tblattendance';
	...
	{
        $this->Createtable->location('admin/tblattendance/table_show');
        ...
        $this->load->view('admin/tblattendance/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/tblattendance/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/tblattendance/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$rec = post("rec");
        ...
        $simpan = $this->db->query("
            UPDATE tblattendance SET  idblk = '$idblk', dteDate = '$dteDate', tmeTime = '$tmeTime', waktu = '$waktu', rec = '$rec' WHERE idAttendance = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-tblattendance.xlsx')
    {
