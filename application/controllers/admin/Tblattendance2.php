...
class Tblattendance2 extends CI_Controller {

	private $table1 = 'tblattendance2';
	...
	{
        $this->Createtable->location('admin/tblattendance2/table_show');
        ...
        $this->load->view('admin/tblattendance2/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/tblattendance2/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/tblattendance2/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$rec = post("rec");
        ...
        $simpan = $this->db->query("
            UPDATE tblattendance2 SET  idblk = '$idblk', dteDate = '$dteDate', tmeTime = '$tmeTime', waktu = '$waktu', rec = '$rec' WHERE idAttendance = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-tblattendance2.xlsx')
    {
