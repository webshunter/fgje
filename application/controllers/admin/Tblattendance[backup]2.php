...
class Tblattendance[backup]2 extends CI_Controller {

	private $table1 = 'tblattendance[backup]2';
	...
	{
        $this->Createtable->location('admin/tblattendance[backup]2/table_show');
        ...
        $this->load->view('admin/tblattendance[backup]2/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/tblattendance[backup]2/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/tblattendance[backup]2/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$rec = post("rec");
        ...
        $simpan = $this->db->query("
            INSERT INTO tblattendance[backup]2
            (idblk,dteDate,tmeTime,waktu,rec) VALUES ('$idblk','$dteDate','$tmeTime','$waktu','$rec')
        ");
    

        if($simpan){
            redirect('admin/tblattendance[backup]2');
        }
    }
...
$rec = post("rec");
        ...
        $simpan = $this->db->query("
            UPDATE tblattendance[backup]2 SET  idblk = '$idblk', dteDate = '$dteDate', tmeTime = '$tmeTime', waktu = '$waktu', rec = '$rec' WHERE idAttendance = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-tblattendance[backup]2.xlsx')
    {
