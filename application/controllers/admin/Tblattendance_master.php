...
class Tblattendance_master extends CI_Controller {

	private $table1 = 'tblattendance_master';
	...
	{
        $this->Createtable->location('admin/tblattendance_master/table_show');
        ...
        $this->load->view('admin/tblattendance_master/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/tblattendance_master/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/tblattendance_master/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$rec = post("rec");
        ...
        $simpan = $this->db->query("
            UPDATE tblattendance_master SET  idblk = '$idblk', dteDate = '$dteDate', tmeTime = '$tmeTime', waktu = '$waktu', rec = '$rec' WHERE idAttendance = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-tblattendance_master.xlsx')
    {
