...
class Upload_skck extends CI_Controller {

	private $table1 = 'upload_skck';
	...
	{
        $this->Createtable->location('admin/upload_skck/table_show');
        ...
        $this->load->view('admin/upload_skck/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/upload_skck/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/upload_skck/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$file = post("file");
        ...
        $simpan = $this->db->query("
            UPDATE upload_skck SET  id_biodata = '$id_biodata', namadok = '$namadok', penting = '$penting', cekdokumen = '$cekdokumen', tglterima = '$tglterima', keterangan = '$keterangan', status = '$status', file = '$file' WHERE id_skck = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-upload_skck.xlsx')
    {
