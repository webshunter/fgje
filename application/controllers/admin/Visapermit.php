...
class Visapermit extends CI_Controller {

	private $table1 = 'visapermit';
	...
	{
        $this->Createtable->location('admin/visapermit/table_show');
        ...
        $this->load->view('admin/visapermit/view', $data);
	...
	public function table_show($action = 'show', $keyword = '')
	{
		if ($action == "show") {
            ...
            $this->load->view('templateadmin/head');
            $this->load->view('admin/visapermit/edit', $data);
            $this->load->view('templateadmin/footer');
    ...
    {
        $this->load->view('templateadmin/head');
        $this->load->view('admin/visapermit/tambah');
        $this->load->view('templateadmin/footer');
    }
...
$tglminta = post("tglminta");
        ...
        $simpan = $this->db->query("
            UPDATE visapermit SET  id_biodata = '$id_biodata', no = '$no', tglterbit = '$tglterbit', tglexp = '$tglexp', tglterima = '$tglterima', tglsimpan = '$tglsimpan', tglbawa = '$tglbawa', tglminta = '$tglminta' WHERE id_suhan = '$key'
            ");
    ...
    public function exls(array $data = [], array $headers = [], $fileName = 'data-visapermit.xlsx')
    {
