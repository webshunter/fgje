<?php 
	...
	else if($sektor == NULL) { $sekt = 'Keseluruhan'; }

	//if($tanggal == NULL) { $tggl = ""; } else { $tggl = $tanggal; }
	//if($jenis == NULL) { $jens = ""; } else { $jens = $jenis; }
?>
        ...
        <div class='page-header'>
            ...
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='separator'>
                    	<?php if($tanggal == NULL && $jenis == NULL) {
                    		echo "";
                    	} else { ?>
                        <i class='icon-angle-right'></i>
                        <?php echo $tanggal.", Absen ".$jenis; ?>
                        <?php } ?>
                    </li>
                </ul>
            </div>
