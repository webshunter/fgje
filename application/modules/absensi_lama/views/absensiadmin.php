<?php 
	if($sektor == 'MF') { $sekt = 'Male Formal'; }
	else if($sektor == 'MI') { $sekt = 'Male Informal'; }
	else if($sektor == 'FF') { $sekt = 'Female Formal'; }  
	else if($sektor == 'FI') { $sekt = 'Female Informal'; }
	else if($sektor == 'JP') { $sekt = 'Jompo'; }
	else if($sektor == '') { $sekt = 'Keseluruhan'; }
?>
...
<div class='row-fluid'>
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>Absensi Tanggal : <?php echo $tanggal; ?></span>
            </h1>
...
<ul class="nav nav-tabs">
    ...
    <li class='active'><a href='#daftar' data-toggle='tab'>Daftar Absensi $bulan $tahun</a></li>
		";
	}
    ?> 
</ul>
			...
			<div class="span12">
						...
						<div class="controls span3">
							...
							<div class='datepicker input-append' id='datepicker'>
														<?php $tggl = date("d/m/Y"); ?>
													                        ...
													                        <input class='input-medium' data-format='dd/mm/yyyy' value="<?php echo $tggl; ?>" name="tanggal"  placeholder='Select datepicker' type='text' />
													            <span class='add-on'>
				...
				<div class="widget">
					<div class="widget-title">
						<h4><i class="icon-reorder"></i> Daftar Personal <?php echo $sekt; ?></h4>
						<span class="tools">
						...
						<table class="table table-striped table-bordered" id="sample_2">
							...
							<tbody>
								...
								<tr class="odd gradeX">
									...
									<td class="hidden-phone"><a href="<?php echo site_url('absensi/tambah_absensi/'.$has1->id_biodata); ?>" class="btn btn-primary">Absen</a></td>
								</tr>
								<?php } ?>
							</tbody>
						</table>
	...
	<div class="tab-pane" id="daftar">
		<div class="row-fluid">
			<div class="span9">
				...
				<div class="widget">
					<div class="widget-title">
						<h4><i class="icon-reorder"></i> Data Absensi Keseluruhan</h4>
						<span class="tools">
							<a href="javascript:;" class="icon-chevron-down"></a>
							<a href="javascript:;" class="icon-remove"></a>
						</span>
	...
	<div class="tab-pane active" id="daftar">
		<div class="row-fluid">
			<div class="span9">
				<form class="form-horizontal" method="post" action="<?php echo site_url('absensi/detail'); ?>">
					<div class="control-group span12">
						<label class="control-label span1">Atur</label>
						...
						<button type="submit" class="btn blue" name="bulantahun"><i class="icon-ok"></i> Atur</button>
					</div>
				</form>
				<div class="widget">
					<div class="widget-title">
						<h4><i class="icon-reorder"></i> Data Absensi <?php echo $bulan." ".$tahun; ?></h4>
						<span class="tools">
							<a href="javascript:;" class="icon-chevron-down"></a>
							<a href="javascript:;" class="icon-remove"></a>
						</span>
