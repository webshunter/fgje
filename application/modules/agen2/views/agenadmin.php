 ...
 <th>Option</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td><?php echo $no;?></td>
                                           <td><a href="<?php echo site_url('agen/detailagen1/'.$row->id_agen); ?>" class="btn btn-mini btn-primary" type="button">Tampil Agree (1)</a> </td>  
                                           <td><a href="<?php echo site_url('agen/detailagen2/'.$row->id_agen); ?>" class="btn btn-mini btn-primary" type="button">Tampil Agree (2)</a> </td>
                                           <td><a href="<?php echo site_url('agen/detailagen3/'.$row->id_agen); ?>" class="btn btn-mini btn-primary" type="button">Tampil Agree (3)</a> </td> 
                                              <td>
                          ...
                          <input type="hidden" class="form-control" name="id_agen" value="<?php echo $row->id_agen; ?>">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span10 " name="group" data-placeholder="Choose a Category" tabindex="1">
                                                                            <option value="<?php echo $row->kode_group;?>" /><?php echo $row->nama;?>
                                                                        <?php  foreach ($tampil_pilihan_group as $pilihan) { ?>
