<div class='row-fluid'>
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <h3><span>SURAT NOTARISAN KELUARGA <strong>( FORMAL/ INFORMAL/ PANTI-JOMPO )</strong></span></h3>
            </h1>
                    ...
                    <li class='active'>Print Surat Perjanjian Penempatan</li>
                           ...
                           <div class='row-fluid'>
                            ...
                            <div class='box-header red-background'>
                                ...
                                <div class='actions'>
                           			 <a href="<?php echo site_url().'/surat_perjanjian_formal'; ?>" role="button" class="btn btn-primary" data-toggle="modal">Lihat Detail Data</a>
                                </div>
                            </div>
                            ...
                            <div class='box-header orange-background'>
                                ...
                                <div class='actions'>
                           			 <a href="<?php echo site_url().'/surat_perjanjian_informal'; ?>" role="button" class="btn btn-primary" data-toggle="modal">Lihat Detail Data</a>
                                </div>
                            </div>
                            <div class='box-content box-no-padding'>
                            <div class='responsive-table'>
                            ...
                            <div class='box-header green-background'>
                                ...
                                <div class='actions'>
                           			 <a href="<?php echo site_url().'/surat_perjanjian_jompo'; ?>" role="button" class="btn btn-primary" data-toggle="modal">Lihat Detail Data</a>
                                </div>
                            </div>
                            <div class='box-content box-no-padding'>
                            <div class='responsive-table'>
