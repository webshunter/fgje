...
<div class='row-fluid pricing-tables'>
    <div class='span3 pricing-table'>
        ...
        <div class='footer'>
            <a href="<?php echo site_url().'/dataadminmaleformal'; ?>" class="btn btn-primary"><i class='icon-signin'></i>
                Detail
            </a>
        </div>
    </div>
    <div class='span3 pricing-table'>
        ...
        <div class='footer'>
            <a href="<?php echo site_url().'/dataadminmaleinformal'; ?>" class="btn btn-warning"><i class='icon-signin'></i>
                Detail
            </a>
        </div>
    </div>
    <div class='span3 pricing-table'>
        ...
        <div class='footer'>
            <a href="<?php echo site_url().'/dataadminfemaleformal'; ?>" class="btn btn-danger"><i class='icon-signin'></i>
               Detail
            </a>
        </div>
    </div>
    <div class='span3 pricing-table'>
        ...
        <div class='footer'>
            <a href="<?php echo site_url().'/dataadminfemaleinformal'; ?>" class="btn btn-info "><i class='icon-signin'></i>
               Detail
            </a>
        </div>
    </div>
...
<div class='row-fluid pricing-tables'>
        ...
        <div class='footer'>
            <a href="<?php echo site_url().'/dataadminpantijompo'; ?>" class="btn btn-warning"><i class='icon-signin'></i>
                Detail
            </a>
        </div>
    </div>
