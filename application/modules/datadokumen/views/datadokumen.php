...
<div class='row-fluid pricing-tables'>
    <div class='span3 pricing-table'>
        ...
        <div class='footer'>
            <a href="<?php echo site_url().'/datadokumenmaleformal'; ?>" class="btn btn-primary"><i class='icon-signin'></i>
                Detail
            </a>
        </div>
    </div>
    <div class='span3 pricing-table'>
        ...
        <div class='footer'>
            <a href="<?php echo site_url().'/datadokumenmaleinformal'; ?>" class="btn btn-warning"><i class='icon-signin'></i>
                Detail
            </a>
        </div>
    </div>
    <div class='span3 pricing-table'>
        ...
        <div class='footer'>
            <a href="<?php echo site_url().'/datadokumenfemaleformal'; ?>" class="btn btn-danger"><i class='icon-signin'></i>
               Detail
            </a>
        </div>
    </div>
    <div class='span3 pricing-table'>
        ...
        <div class='footer'>
            <a href="<?php echo site_url().'/datadokumenfemaleinformal'; ?>" class="btn btn-info "><i class='icon-signin'></i>
               Detail
            </a>
        </div>
    </div>
...
<div class='row-fluid pricing-tables'>
        ...
        <div class='footer'>
            <a href="<?php echo site_url().'/datadokumenpantijompo'; ?>" class="btn btn-warning"><i class='icon-signin'></i>
                Detail
            </a>
        </div>
    </div>
