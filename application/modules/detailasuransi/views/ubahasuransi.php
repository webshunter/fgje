...
<div class="row-fluid">
 ...
 <div class="span8">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>Tambah DATA asuransi 簽證</h4><span class="tools"><a href="javascript:;" class="icon-chevron-down"></a><a href="javascript:;" class="icon-remove"></a></span></div>
                                <div class="widget-body">
...
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$idbiodatanya ?>" class="hidden" />
															...
															<label class="control-label span4"> No asuransi </label>
															<div class="controls">
																<input type="text" name="noasuransi" value="<?php echo $row->noasuransi;?>" class="span4 popovers" data-trigger="hover" data-content="Isi Nama Lengkap Sesuai dengan KTP" data-original-title="Nama Lengkap" />
															</div>
															</div>

															<div class="control-group" id="berlaku">
																<label class="control-label span4"> Tanggal Asuransi </label>
																<div class="controls">
																	<div class="input-append date date-picker" data-date="2012-02-22" data-date-format="yyyy.mm.dd" data-date-viewmode="years">
																		<input class=" m-ctrl-medium date-picker span7" name="tglasuransi" value="<?php echo $row->tglasuransi;?>"  size="16" data-date-format="yyyy.mm.dd" type="text" value="" /><span class="add-on"><i class="icon-calendar"></i></span></div>
																</div>
															</div>


															<div class="control-group">
															<label class="control-label span4"> Jumlah Dana </label>
															<div class="controls">
																<input type="text" name="jumlah" value="<?php echo $row->jumlah;?>"  class="span4 popovers" data-trigger="hover" data-content="Isi Nama Lengkap Sesuai dengan KTP" data-original-title="Nama Lengkap" />
															</div>
															</div>
                                    ...
                                    <a type="button" class="btn" href="<?php echo base_url()."index.php/detailasuransipermit/"?>"><i class=" icon-remove"></i> Kembali </a>
                                </div>
