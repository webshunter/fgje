...
<form action="<?php echo site_url('tambahinterview/ubahinterviewdata');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
 <?php foreach ($tampil_data_interview as $row) { ?>
<input type="text" id="id_interview" name="id_interview" value="<?php echo $row->id_interview ?>" class="hidden" />
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span4 " name="sunction" data-placeholder="Choose a Category" tabindex="1">
                                                                        <option value="<?php echo $row->sunction ?>" /><?php echo $row->sunction ?>
                                                                        <option value="Y/有" />Y/有
                                                                        <option value="N/ 沒有" />N/ 沒有
                                                                        </select>
                                                                </div>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span4 " name="cateter" data-placeholder="Choose a Category" tabindex="1">
                                                                        <option value="<?php echo $row->cateter ?>" /><?php echo $row->cateter ?>
                                                                        <option value="Y/有" />Y/有
                                                                        <option value="N/ 沒有" />N/ 沒有
                                                                        </select>
                                                                </div>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span4 " name="injection" data-placeholder="Choose a Category" tabindex="1">
                                                                        <option value="<?php echo $row->injection ?>" /><?php echo $row->injection ?>
                                                                        <option value="Y/有" />Y/有
                                                                        <option value="N/ 沒有" />N/ 沒有
                                                                        </select>
                                                                </div>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span4 " name="therapy" data-placeholder="Choose a Category" tabindex="1">
                                                                       <option value="<?php echo $row->therapy ?>" /><?php echo $row->therapy ?>
                                                                        <option value="Y/有" />Y/有
                                                                        <option value="N/ 沒有" />N/ 沒有
                                                                        </select>
                                                                </div>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span4 " name="helping" data-placeholder="Choose a Category" tabindex="1">
                                                                       <option value="<?php echo $row->helping ?>" /><?php echo $row->helping ?>
                                                                        <option value="Y/有" />Y/有
                                                                        <option value="N/ 沒有" />N/ 沒有
                                                                        </select>
                                                                </div>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span4 " name="bed" data-placeholder="Choose a Category" tabindex="1">
                                                                        <option value="<?php echo $row->bed ?>" /><?php echo $row->bed ?>
                                                                        <option value="Y/有" />Y/有
                                                                        <option value="N/ 沒有" />N/ 沒有
                                                                        </select>
                                                                </div>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select class="span4 " name="stairs" data-placeholder="Choose a Category" tabindex="1">
                                                                        <option value="<?php echo $row->stairs ?>" /><?php echo $row->stairs ?>
                                                                        <option value="Y/有" />Y/有
                                                                        <option value="N/ 沒有" />N/ 沒有
                                                                        </select>
                                                                </div>
