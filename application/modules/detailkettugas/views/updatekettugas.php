                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title"> Tambah Keterangan Tugas <small>Menambahkan Keterangan Tugas Pendaftar</small></h3>
                        <ul class="breadcrumb">
                            <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Admin</a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Tambah Keterangan Tugas</a><span class="divider-last">&nbsp;</span></li>
				...
				<div class="row-fluid">
					...
					<div class="span8">
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>Update Keterangan Tugas</h4>
                                <span class="tools">
                            ...
                            <div class="widget-body">
								<form action="<?php echo site_url('detailkettugas/updatekettugas');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                    ...
                                    <div class="control-group"> <!-- Tugas 1 -->
										<label class="control-label span6">Merawat bayi baru lahir sampai 3 bulan <br>照顧零至三個月大之小孩</label>
										<div class="controls">
