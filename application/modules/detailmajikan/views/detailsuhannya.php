    ...
    <link href='<?php echo base_url(); ?>assets/stylesheets/demo.css' media='all' rel='stylesheet' type='text/css' />
                                    ...
                                    <div class="controls">
                                       ...
                                       <div class="control-group">
                                          ...
                                          <?php   echo form_dropdown("id_suhan",$option_suhan,"","id='id_suhan'"); ?>
                                          <div id="load" style="display:none"><img src="<?php echo base_url(); ?>assets/assets/pre-loader/Whirlpool.gif" alt="Whirlpool" /></div>

                                         </div>
                                         </div>

                                         <div class="control-group" id="jelasin_visapermit">
                                         <label class="control-label">Pilih Visa Permit </label>
                                         <div class="controls">
                                         <?php    echo form_dropdown("id_suhan",array('Pilih Group'=>'Pilih Suhan Terkebih Dahulu'),'','disabled'); ?>
                                         </div>
                                           </div> 

                                               <script type="text/javascript">

    $("#id_suhan").change(function(){
    var id_suhan = {id_suhan:$("#id_suhan").val()};
    document.getElementById("load").style.display = "block";  // show the loading message.
    $.ajax({
        type: "POST",
        url : "<?php echo site_url('detailmajikan/select_visapermitlist')?>",
        data: id_suhan,
        success: function(msg) {
        $('#jelasin_visapermit').html(msg);
