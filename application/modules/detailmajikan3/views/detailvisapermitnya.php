    ...
    <link href='<?php echo base_url(); ?>assets/stylesheets/demo.css' media='all' rel='stylesheet' type='text/css' />
                                    ...
                                    <div class="controls">
                                       ...
                                       <div class="control-group">
                                          ...
                                          <?php   echo form_dropdown("id_visapermit",$option_visapermit,"","id='id_visapermit'"); ?>
                                        ...
                                        <!--  <div class="control-group" id="jelasin_suhan">
                                         ...
                                         <div class="controls">
                                         <?php    echo form_dropdown("id_suhan",array('Pilih Group'=>'Pilih Majikan Terkebih Dahulu'),'','disabled'); ?>
                                         </div>
                                           </div> -->
