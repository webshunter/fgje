<div class='row-fluid'>
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>Data Marketing Majikan </span>
            </h1>
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>>Data Marketing Majikan </li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class='actions'>
                ...
                <a href="#" class="btn box-collapse btn-mini btn-link"><i></i>
                            ...
                            <div class='box-content box-no-padding'>
                                   ...
                                   <?php echo form_open('detailmajikan/ubahgrupmajikanformal/'.$detailpersonalid,array('class'=>'form-horizontal')); ?>     
 ...
 <div class="alert alert-info">
                        ...
                        <a>Data Yang Akan di ubah</a>
                                            ...
                                            <div class="control-group">
                                                            ...
                                                            <div class="control-group">
                                                             ...
                                                             <label class="control-label span4">Data Majikan </label>
                                                            <div class="controls">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" class="span5 popovers" name="nama_pabriks" data-trigger="hover" data-content="" data-original-title="Grup" value="<?php echo $row->nosuhannya; ?>" disabled/>
                                                            </div>
                                                            </div>

                                                            <div class="control-group">
                                                            <label class="control-label span4">Data Visa Permit </label>
                                                            <div class="controls">
                                                                <input type="text" class="span5 popovers" name="nama_pabriks" data-trigger="hover" data-content="" data-original-title="Grup" value="<?php echo $row->novisapermitnya; ?>" disabled/>
                                                            </div>
                                                            </div>
                        ...
                        <input type="text" class="form-control" name="id_majikan" value="<?php echo $row->idmajikanmu; ?>">
  <?php }?>
                                   <div class="control-group">
