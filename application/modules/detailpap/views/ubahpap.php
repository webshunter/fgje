...
<div class="row-fluid">
 ...
 <div class="span8">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>Tambah DATA pap 簽證</h4><span class="tools"><a href="javascript:;" class="icon-chevron-down"></a><a href="javascript:;" class="icon-remove"></a></span></div>
                                <div class="widget-body">

<form action="<?php echo site_url('detailpap/ubahpap');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
...
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$idbiodatanya ?>" class="hidden" />
															...
															<label class="control-label span4"> No pap </label>
															<div class="controls">
																<input type="text" name="nopap" value="<?php echo $row->nopap;?>" class="span4 popovers" data-trigger="hover" data-content="Isi Nama Lengkap Sesuai dengan KTP" data-original-title="Nama Lengkap" />
															</div>
															</div>

															<div class="control-group" id="berlaku">
																<label class="control-label span4"> Tanggal PAP </label>
																<div class="controls">
																	<div class="input-append date date-picker" data-date="2012-02-22" data-date-format="yyyy.mm.dd" data-date-viewmode="years">
																		<input class=" m-ctrl-medium date-picker span7" name="tglpap" value="<?php echo $row->tglpap;?>" size="16" data-date-format="yyyy.mm.dd" type="text" value="" /><span class="add-on"><i class="icon-calendar"></i></span></div>
																</div>
															</div>
...
<?php } ?>
                                    ...
                                    <a type="button" class="btn" href="<?php echo base_url()."index.php/detailpappermit/"?>"><i class=" icon-remove"></i> Kembali </a>
                                </div>
