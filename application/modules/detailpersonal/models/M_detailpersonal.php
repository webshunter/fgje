...
/*
        ...
        $this->db->where('nodaftar', $idbio);
        $this->db->update('blk_izin_pulang', $data3);
        ...
        $this->db->update('disnaker', $data4);

        $data5 = array(  
            'idblk'    => $this->input->post('idp')
        );

        $this->db->where('idblk', $idbio);
        $this->db->update('tblattendance', $data5);
*/
    } 
