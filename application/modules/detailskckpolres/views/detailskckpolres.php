        ...
        <div class='page-header'>
            ...
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Detail SKCK (POLRES) </li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row-fluid">
    ...
    <div class='span12 box bordered-box blue-border' style='margin-bottom:0;'>
            ...
            <div class='title'>Detail SKCK (POLRES)</div>
            <div class='actions'>
 ...
 <div class='span6 box-quick-link blue-background'>
                <a href='<?php echo site_url().'/upload_skckpolres'; ?>'>
                    <div class='header'>
                        <div class='icon-flag'></div>
                    </div>
                    <div class='content'><b>SKCK (POLRES)</b></div>
...
<div class='modal hide fade' id='tambah' role='dialog' tabindex='-1'>
  ...
  <form action="<?php echo site_url('detailskckpolres/tambahskck');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
...
<div class='modal hide fade' id='ubah' role='dialog' tabindex='-1'>
                ...
                <div class='modal-body'>
  <form action="<?php echo site_url('detailskckpolres/ubahskck');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
