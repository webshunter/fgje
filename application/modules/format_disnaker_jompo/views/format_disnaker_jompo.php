    ...
    <div class='page-header'>
      ...
      <div class='pull-right'>
        <ul class='breadcrumb'>
          ...
          <li class='active'>Print Format Disnaker Jompo</li>
        </ul>
      </div>
    </div>
  </div>
          ...
          <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td ><a href="<?php echo base_url(); ?>baru6/cetak/<?php echo $row->id_biodata;?>" class="btn btn-warning">Print</a></td>
              </tr>
              </tbody>
           <div id="myModal2<?php echo $no; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
              ...
              <div class="modal-body" >
                <form action="<?php echo site_url('format_disnaker_jompo/edit_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
             ...
             <div id="hapus<?php echo $no; ?>" class="modal hide fade" tabindex="-hapus" role="dialog" aria-labelledby="hapus" aria-hidden="true">
              ...
              <div class="modal-body">
                <form action="<?php echo site_url('format_disnaker_jompo/hapus_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
            ...
            <div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
              ...
              <div class="modal-body" >
                <form action="<?php echo site_url('format_disnaker_jompo/simpan_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
