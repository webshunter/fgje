                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span5">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                <?php echo form_open('kreditbank/update_data_kreditbank/'.$kreditbank->id_kreditbank, array('class' => "form-horizontal", 'autocomplete' => 'off', 'role'=>'form')) ?>
                                                         ...
                                                         <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="nama_kredit" class="span10 popovers" value="<?php echo $kreditbank->namakredit; ?>"/>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="jumlahkredit" class="span10 popovers" value="<?php echo $kreditbank->isikredit; ?>"/>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="nilaikredit" class="span10 popovers" value="<?php echo $kreditbank->nilaikredit; ?>"/>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="mandarinnya" class="span10 popovers" value="<?php echo $kreditbank->mandarinnya; ?>"/>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="statuskredit" class="span10 popovers" value="<?php echo $kreditbank->statuskredit; ?>"/>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="mandarinnya2" class="span10 popovers" value="<?php echo $kreditbank->mandarinnya2; ?>"/>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="statuskredit2" class="span10 popovers" value="<?php echo $kreditbank->statuskredit2; ?>"/>
                                                            </div>
                                                            </div>
