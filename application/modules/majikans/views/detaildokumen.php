    ...
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>Detail Permintaan Dokumen Majikan </span>
            </h1>
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Detail Permintaan Dokumen Majikan</li>
                </ul>
            </div>
        </div>
    </div>
...
<a class='btn btn-info btn-large' data-toggle='modal' href='#tambahagama' role='button'>Tambah Dokumen</a>
 <a href="<?php echo site_url('majikans/'); ?>" class='btn btn-info btn-large' type="button">Kembali</a>
