<link href='<?php echo base_url(); ?>assets/stylesheets/bootstrap/bootstrap.css' media='all' rel='stylesheet' type='text/css' />
   ...
   <div class="control-group">
                                          ...
                                          <?php   echo form_dropdown("kode_agen",$option_agen,"","id='kode_agen'"); ?>
                                         ...
                                         <div class="controls">
                                         <?php    echo form_dropdown("kode_agen",array('Pilih Group'=>'Pilih Agen Terkebih Dahulu'),'','disabled'); ?>
                                         </div>
                                           </div> 
    ...
    $.ajax({
        type: "POST",
        url : "<?php echo site_url('majikans/select_majikanlist2')?>",
        data: kode_agen,
