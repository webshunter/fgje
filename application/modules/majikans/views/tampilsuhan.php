            ...
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Detail History Suhan</li>
                          ...
                          <div class='row-fluid'>
    <div class='span12'>
<a class='btn btn-info btn-large' data-toggle='modal' href='#tambahagama' role='button'>Tambah History Suhan</a>
...
<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                            <div class='box-header orange-background'>
                                <div class='title'>Suhan <?php echo $ambidatasuhan;?> - <?php echo $ambidatasuhanmajikan;?> </div>
                                <div class='actions'>
 ...
 <div class='modal hide fade' id='edit<?php echo $no; ?>' role='dialog' tabindex='-1'>
                ...
                <form class="form-horizontal" method="post" action="<?php echo site_url('majikans/update_history_suhan/'.$idnya); ?>">
 ...
 <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-2" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('majikans/hapus_history_suhan/'.$idnya); ?>">
                           <div class="modal-header">
   ...
   <div class='modal hide fade' id='tambahagama' role='dialog' tabindex='-2'>
                ...
                <div class='modal-body'>
<form action="<?php echo site_url('majikans/simpan_history_suhan/'.$idnya);?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
