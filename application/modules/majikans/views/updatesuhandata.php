...
function goBack() {
    window.history.back();
     ...
     <form action="<?php echo site_url('majikans/update_data_suhandata');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
...
<div class="form-actions">
                                            <?php echo form_submit('submit', 'Update', "class = 'btn blue'"); ?>
                                                <a href="<?php echo site_url('majikans/tampildatasuhan/'.$kodemajikan.'/'.$kodeagen.'/'.$kodegroup); ?>" class="btn red btn-medium">Batal</a>
                                        </div>
                                    </form>
                        </div>
                    </div>