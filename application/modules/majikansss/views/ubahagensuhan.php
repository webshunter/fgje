<div class='row-fluid'>
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>Ubah Data Majikan Suhan </span>
            </h1>
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Ubah Data Majikan Suhan </li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class='title'>Ubah Data Majikan Suhan  </div>
            <div class='actions'>
 ...
 <div class="alert alert-info">
                        ...
                        <a>Update Data Agen</a>
                                   ...
                                   <?php echo form_open('majikans/ubahagensuhan/',array('class'=>'form-horizontal')); ?>     
