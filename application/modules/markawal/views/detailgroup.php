<link href='<?php echo base_url(); ?>assets/stylesheets/bootstrap/bootstrap.css' media='all' rel='stylesheet' type='text/css' />
    ...
    <link href='<?php echo base_url(); ?>assets/stylesheets/demo.css' media='all' rel='stylesheet' type='text/css' />
          ...
          <div class="control-group">
                                    <label class="control-label">Pilih Agenasdasdasd </label>
                                    <div class="controls">
                                        <select class="chosen" data-placeholder="Choose a Category" tabindex="1" name="kode_agen">
...
<!-- 
                                          ...
                                          <?php   echo form_dropdown("kode_agen22",$option_agen,"","id='kode_agen22'"); ?>
                                          <!-- <div id="load2" style="display:none"><img src="<?php echo base_url(); ?>assets/assets/pre-loader/Whirlpool.gif" alt="Whirlpool" /></div> -->

                                         <!-- </div>
                                         </div>

                                         <div class="control-group" id="jelasin_majikan2">
                                         <label class="control-label">Pilih Majikan </label>
                                         <div class="controls">
                                         <?php    echo form_dropdown("kode_agen22",array('Pilih Group'=>'Pilih Agen Terkebih Dahulu'),'','disabled'); ?>
                                         </div>
                                           </div> -->

    <script type="text/javascript">

    //                                            $("#kode_agen22").change(function(){
    // var kode_agen = {kode_agen:$("#kode_agen22").val()};
    // document.getElementById("load").style.display = "block";  // show the loading message.
    // $.ajax({
    //     type: "POST",
    //     url : "<?php echo site_url('majikans/select_majikanlist')?>",
    //     data: kode_agen,
    //     success: function(msg) {
    //     $('#jelasin_majikan2').html(msg);
