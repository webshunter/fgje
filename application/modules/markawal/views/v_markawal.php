 ...
 <?php foreach ($tampil_data_personal as $row) { ?>
        ...
        ?>
                    ...
                    ?>
                                ...
                                <div class="span9">
                                    <br>
                                    <?php if ($statterbang->statterbang == '') : ?>
                                        <button class="btn btn-default keluarprogress">Keluarkan Dari Progrees</button>
                                          <?php else : ?>
                                        <button class="btn btn-default tambahprogress">Tambahkan ke Progress</button>
                                    <?php endif; ?>
                                      <?php if($row->skill1==""){?>
                          ...
                          <input type="hidden" class="form-control" name="id_marka_bioagen" value="<?php echo $row->id_marka_bioagen; ?>">
                                        ...
                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                             ...
                                                             <div class="control-group" id="berlaku">
                                                                <label class="control-label span4">Tanggal Dilepas </label>
                                                                <div class="controls">
                                                                    <div class='datepicker input-append' id='datepicker'>
                                                                            <input class='input-medium' data-format='yyyy.MM.dd' name="tgldilepas"  placeholder='Select datepicker' type='text' value="<?php echo $row->tgldilepas; ?>"/>
                                                                <span class='add-on'>
                                                                  <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                                                </span>
                                                                        </div>
...
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$detailpersonalid ?>" class="hidden" />
                                        ...
                                        <div class="control-group">
                                          ...
                                          <?php   echo form_dropdown("kode_group",$option_group,"","id='group_idawal'"); ?>
                                                            ...
                                                            <div class="controls">
                                                             ...
                                                             <div class="control-group" id="berlaku">
                                                               ...
                                                               <div class="control-group" id="berlaku">
                                                                ...
                                                                <div class="controls">
                                                                    <div class='datepicker input-append' id='datepicker'>
                                                                            <input class='input-medium' data-format='yyyy.MM.dd' name="tgldilepas"  placeholder='Select datepicker' type='text' />
                                                                <span class='add-on'>
                                                                  <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                                                </span>
                                                                        </div>
...
<script type="text/javascript">
    ...
    $(".tambahprogress").dblclick(function(){
        var idnya = "<?= $detailpersonalid; ?>";
        $.ajax({
            url: "markawal/tambahkankeprogress/"+idnya,
    ...
    $(".keluarprogress").dblclick(function(){
        var idnya = "<?= $detailpersonalid; ?>";
        $.ajax({
            url: "markawal/buangdariprogress/"+idnya,
            success:function(response){
                alert(response);
                location.reload();
            }
