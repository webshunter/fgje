                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title"> Detail Dokumen Medikal, PP, SKCK</h3>
                        <ul class="breadcrumb">
                            <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Admin</a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Detail Dokumen Medikal, PP, SKCK</a><span class="divider-last">&nbsp;</span></li>
                        </ul>
                    </div>
                </div>                    
                                                ...
                                                <div class="accordion " id="accordion1">
                                                                ...
                                                                <table class="table table-borderless">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td> <?php if($row->tgl_legal == NULL) { echo "Belum Ada Keterangan"; } else { echo $row->tgl_legal; } ?> </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="span2">Nama :</td>
                                                                            <td> <?php if($row->nama_legal == NULL) { echo "Belum Ada Keterangan"; } else { echo $row->nama_legal; } ?> </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="span2">Hubungan :</td>
                                                                            <td> <?php if($row->hub_legal == NULL) { echo "Belum Ada Keterangan"; } else { echo $row->hub_legal; } ?> </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="span2">Khusus :</td>
                                                                            <td> <?php if($row->khusus_legal == NULL) { echo "Belum Ada Keterangan"; } else { echo $row->khusus_legal; } ?> </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="span2"></td>
                                                                            <td><a href="<?php echo site_url('markmed/update_legal'); ?>" class="btn btn-primary"><i class="icon-ok"></i> Update</a></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                <?php } ?>
                                                    ...
                                                    <div class="accordion-group">
                                                        ...
                                                        <div id="collapse_2" class="accordion-body collapse in">
                                                            <div class="accordion-inner">
                                                            <form action="<?php echo site_url('markmed/updatenota');?>" method="post" class="form-horizontal"/>
                                                                <?php foreach ($tampil_data_markmed as $row) { ?>
                                                                <input type="text" name="biodata" value="<?php echo $detailpersonalid; ?>" class="hidden">
                                                                <div class="control-group">
                                                                    <label class="control-label">Tanggal</label>
                                                                    <div class="controls">
                                                                        <input class="input-medium date-picker" size="16" type="text" name="tgl_nota" value="<?php echo date('d/m/Y', strtotime($row->tgl_nota)); ?>"/>
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
                                                                    <label class="control-label">Nama</label>
                                                                    <div class="controls">
                                                                        <input type="text" name="nama_nota" class="span10 popovers" value="<?php echo $row->nama_nota; ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
                                                                    <label class="control-label">Hubungan</label>
                                                                    <div class="controls">
                                                                        <input type="text" name="hub_nota" class="span10 popovers" value="<?php echo $row->hub_nota; ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
                                                                    <label class="control-label">Khusus</label>
                                                                    <div class="controls">
                                                                        <input type="text" name="khusus_nota" class="span10 popovers" value="<?php echo $row->khusus_nota ?>">
                                                                    </div>
                                                                </div>
