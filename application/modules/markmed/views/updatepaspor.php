                                                        ...
                                                        <div id="collapse_6" class="accordion-body collapse in">
                                                            ...
                                                            <form action="<?php echo site_url('markmed/updatemurm');?>" method="post" class="form-horizontal"/>
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="text" name="in_paspor" class="span10 popovers" value="<?php echo $row->in_paspor; ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
                                                                    <label class="control-label">Terima Buku</label>
                                                                    <div class="controls">
                                                                        <input class="input-medium date-picker" size="16" type="text" name="bk_paspor" value="<?php echo date('d/m/Y', strtotime($row->bk_paspor)); ?>"/>
                                                                    </div>
                                                                </div>
