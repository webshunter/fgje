                                                ...
                                                <div class="accordion " id="accordion1">
                                                    ...
                                                    <div class="accordion-group">
                                                        ...
                                                        <div id="collapse_7" class="accordion-body collapse in">
                                                            <div class="accordion-inner">
                                                            <form action="<?php echo site_url('markmed/updateskck');?>" method="post" class="form-horizontal"/>
                                                                <?php foreach ($tampil_data_markmed as $row) { ?>
                                                                <input type="text" name="biodata" value="<?php echo $detailpersonalid; ?>" class="hidden">
                                                                <div class="control-group">
                                                                    <label class="control-label">Tanggal Aju</label>
                                                                    <div class="controls">
                                                                        <input class="input-medium date-picker" size="16" type="text" name="aju_skck" value="<?php echo date('d/m/Y', strtotime($row->aju_skck)); ?>"/>
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
                                                                    <label class="control-label">Tanggal Terima</label>
                                                                    <div class="controls">
                                                                        <input class="input-medium date-picker" size="16" type="text" name="trm_skck" value="<?php echo date('d/m/Y', strtotime($row->trm_skck)); ?>"/>
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
                                                                    <label class="control-label">Tanggal Expired</label>
                                                                    <div class="controls">
                                                                        <input class="input-medium date-picker" size="16" type="text" name="exp_skck" value="<?php echo date('d/m/Y', strtotime($row->exp_skck)); ?>"/>
                                                                    </div>
                                                                </div>
