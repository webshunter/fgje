        ...
        <div class='page-header'>
                                                ...
                                                <div class="accordion " id="accordion1">
                                                    ...
                                                    <div class="accordion-group">
                                                        ...
                                                        <div id="collapse_3" class="accordion-body collapse in">
                                                            <form action="<?php echo site_url('markonline/updaterekom');?>" method="post" class="form-horizontal"/>
                                                            <div class="accordion-inner"> 
                                                                <?php foreach ($tampil_data_markonline as $row) { ?>
            ...
            <span class='add-on'>
                <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                                                        ...
                                                                        <!-- <input class="input-medium date-picker" size="16" type="text" name="tgl_buat" value="<?php echo $row->tgl_buat_rekom; ?>"/> -->
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
            ...
            <span class='add-on'>
                <i data-date-icon='icon-calendar' data-time-icon='icon-time'></i>
                                                                        ...
                                                                        <!-- <input class="input-medium date-picker" size="16" type="text" name="tgl_terima_rekom" value="<?php echo $row->tgl_trm_rekom; ?>"/> -->
                                                                    </div>
                                                                </div>
