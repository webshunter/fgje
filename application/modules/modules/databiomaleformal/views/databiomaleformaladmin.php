                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url()."index.php/databiomaleformal/detaildata/".$row->id_biodata; ?>">Detail</a></td>
                                            <td><a href="<?php echo base_url()."index.php/databiomaleformal/detaildataupload/".$row->id_biodata; ?>">Detail Upload</a></td>
