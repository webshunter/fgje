<div class='row-fluid'>
 ...
 <?php foreach ($tampil_data_personal as $row) { ?>
                    ...
                    ?>
                                ...
                                <div class="span9">
                                    <h4> <br /><small><?php echo "".$detailpersonalid ?></small></h4>
                                <?php }?>
 ...
 <div class="alert alert-info">
                        ...
                        <a>Data Yang Akan di ubah</a>
                                            ...
                                            <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" class="span5 popovers" name="nama_pabriks" data-trigger="hover" data-content="" data-original-title="Grup" value="<?php echo $row->kode_group; ?>" disabled/>
                                                            </div>
                                                            </div>
