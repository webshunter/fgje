                ...
                <div class="tabbable tabbable-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a>Data Suhan - 核准函</a></li>
                        <li class="active"><a href="#tab_1_3" data-toggle="tab">Data VISA - 簽證函</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1_3">
                            <div class="span5">
                                <div class="widget">
                                    <div class="widget-title">
                                        <h4><i class="icon-reorder"></i>Update Visa Permit</h4>
                                        <span class="tools">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <?php echo form_open('majikan/update_data_visapermit/'.$visapermit->id_visapermit, array('class' => "form-horizontal", 'autocomplete' => 'off', 'role'=>'form')) ?>
                            ...
                            <div class="span7">
                                <div class="widget">
                                    <div class="widget-title">
                                        <h4><i class="icon-reorder"></i>Data Visa Permit</h4>
                                        <span class="tools">
                                            <a href="javascript:;" class="icon-chevron-down"></a>
                                            <a href="javascript:;" class="icon-remove"></a>
                                        </span>
