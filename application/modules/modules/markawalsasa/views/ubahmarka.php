                                                    ...
                                                    <div class="accordion-group">
                                                        ...
                                                        <div id="collapse_2" class="accordion-body collapse">
															...
															<label class="control-label">Tanggal</label>
																<div class="controls">
																<div class="input-append date date-picker"  data-date="2012-02-22" data-date-format="yyyy.mm.dd" data-date-viewmode="years">
																		<input class=" m-ctrl-medium date-picker span9" size="27" id="tgl_to_agen" name="tgl_to_agen" data-date-format="yyyy.mm.dd" type="text" value="<?php echo $row->tgl_to_agen;?>" /><span class="add-on"><i class="icon-calendar"></i></span></div>
																</div>
															...
															<label class="control-label">Agen</label>
															<div class="controls">
																<input type="text" class="span5 popovers" name="nama_agen" value="<?php echo $row->nama_agen;?>" data-trigger="hover" data-content="" data-original-title="Agen" />
															</div>
															</div>
															...
															<label class="control-label">Grup</label>
															<div class="controls">
																<input type="text" class="span5 popovers" name="grup_to_agen" value="<?php echo $row->grup_to_agen;?>" data-trigger="hover" data-content="" data-original-title="Grup" />
															</div>
															</div>
															...
															<div class="controls">
																<input type="text" class="span5 popovers" name="nama_pabrik" value="<?php echo $row->nama_pabrik;?>" data-trigger="hover" data-content="" data-original-title="Grup" />
															</div>
															</div>
															...
															<label class="control-label">Tanggal Pauliu</label>
																...
																<div class="controls">
																<div class="input-append date date-picker"  data-date="2012-02-22" data-date-format="yyyy.mm.dd" data-date-viewmode="years">
																		<input class=" m-ctrl-medium date-picker span9" size="27" id="tgl_pauliu" name="tgl_pauliu" data-date-format="yyyy.mm.dd" type="text" value="<?php echo $row->tgl_pauliu;?>" /><span class="add-on"><i class="icon-calendar"></i></span></div>
																</div>
															...
															<label class="control-label">Tanggal Interview</label>
																...
																<div class="controls">
																<div class="input-append date date-picker"  data-date="2012-02-22" data-date-format="yyyy.mm.dd" data-date-viewmode="years">
																		<input class=" m-ctrl-medium date-picker span9" size="27" id="tgl_inter" name="tgl_inter" data-date-format="yyyy.mm.dd" type="text" value="<?php echo $row->tgl_inter;?>" /><span class="add-on"><i class="icon-calendar"></i></span></div>
																</div>
