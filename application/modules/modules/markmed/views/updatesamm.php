                                                ...
                                                <div class="accordion " id="accordion1">
                                                    ...
                                                    <div class="accordion-group">
                                                        ...
                                                        <div id="collapse_4" class="accordion-body collapse in">
                                                            <div class="accordion-inner">
                                                            <form action="<?php echo site_url('markmed/updatesamm');?>" method="post" class="form-horizontal"/>
                                                                <?php foreach ($tampil_data_markmed as $row) { ?>
                                                                <input type="text" name="biodata" value="<?php echo $detailpersonalid; ?>" class="hidden">
                                                                <div class="control-group">
                                                                    <label class="control-label">Tanggal</label>
                                                                    <div class="controls">
                                                                        <input class="input-medium date-picker" size="16" type="text" name="tgl_samm" value="<?php echo date('d/m/Y', strtotime($row->tgl_samm)); ?>"/>
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
                                                                    <label class="control-label">Tanggal Expired</label>
                                                                    <div class="controls">
                                                                        <input class="input-medium date-picker" size="16" type="text" name="exp_samm" value="<?php echo date('d/m/Y', strtotime($row->exp_samm)); ?>"/>
                                                                    </div>
                                                                </div>
