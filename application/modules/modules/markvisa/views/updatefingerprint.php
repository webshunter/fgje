                                                ...
                                                <div class="accordion " id="accordion1">
                                                    ...
                                                    <div class="accordion-group">
                                                        ...
                                                        <div id="collapse_2" class="accordion-body collapse in">
                                                            <form action="<?php echo site_url('markvisa/updatefingerprint');?>" method="post" class="form-horizontal"/>
                                                            <div class="accordion-inner">
                                                                <?php foreach ($tampil_data_markvisa as $row) { ?>
                                                        ...
                                                        <div id="collapse_4" class="accordion-body collapse">
                                                            <div class="accordion-inner">
                                                                ...
                                                                <table class="table table-borderless">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="span3">PAP Perkiraan:</td>
                                                                            <td> <?php echo $row->pap_perkiraan; ?> </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="span3">Dokumen:</td>
                                                                            <td>
                                                                                            ...
                                                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                                                ...
                                                                                                <div>
                                                                                                    <form method="post" action="<?php echo site_url('markvisa/updatedokpap');?>" enctype="multipart/form-data">
                                                                                                        ...
                                                                                                        <button type="submit" class="btn btn-primary fileupload-exists">OK</button>
                                                                                                        <label>Terakhir upload : <?php echo $row->terakhir_pap; ?></label>
                                                                                                    </form>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                        ...
                                                                        <tr>
                                                                            <td class="span2"></td>
                                                                            <td> 
                                                                                <a href="<?php echo site_url('markvisa/update_pap'); ?>" class="btn btn-primary"><i class="icon-ok"></i> Update</a>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
