                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $row->mandarin;?></td>
                                             <td><?php echo $row->kategorinya;?></td>
                                               ...
                                               <td>
                                            <a href="#" class="btn btn-mini btn-primary" data-toggle="modal" data-target="#editpekerjaan<?php echo $no; ?>"><span>Edit</span></a>  
                                            </td>
                                            <td>
                                        <a href="#" class="btn btn-mini btn-primary" data-toggle="modal" data-target="#hapuspekerjaan<?php echo $no; ?>"><span>Hapus</span></td>
                                        </tr>
   <div class='modal hide fade' id='editpekerjaan<?php echo $no; ?>' role='dialog' tabindex='-1'>
                <div class='modal-header'>
                    <button class='close' data-dismiss='modal' type='button'>&times;</button>
                    <h3>UPDATE PEKERJAAN</h3>
                </div>  
                <form class="form-horizontal" method="post" action="<?php echo site_url('pekerjaan/update_pekerjaan'); ?>">
                          ...
                          <input type="hidden" class="form-control" name="id_pekerjaan" value="<?php echo $row->id_pekerjaan; ?>">
 <div class="control-group">
                                                                <label class="control-label">Kategori </label>
                                                                <div class="controls">
                                                                    <select name="kategori" class="span11 " data-placeholder="Choose a Category" tabindex="1">
                                                                        <option value="<?php echo $row->id_kategori; ?>" /><?php echo $row->kategorinya; ?>
                                    ...
                                    <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="nama_pekerjaan" class="span11 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" value="<?php echo $row->isi; ?>"/>
                                                            </div>
                                                            </div>
                                    <div class="control-group">
                                                            <label class="control-label">Jenis Usaha (Bahasa Taiwan)</label>
                                                            <div class="controls">
                                                                <input type="text" name="nama_pekerjaan_taiwan" class="span11 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal Dalam Bahasa Taiwan" data-original-title="Nama Sektor (Bahsa Taiwan)" value="<?php echo $row->mandarin; ?>"/>
                                                            </div>
                                                            </div>
 ...
 <div class="modal fade" id="hapuspekerjaan<?php echo $no; ?>" tabindex="-2" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           ...
                           <div class="modal-body">
                             <input type="hidden" class="form-control" name="id_pekerjaan" value="<?php echo $row->id_pekerjaan; ?>">
                              <p>Apakah anda yakin akan menghapus data Pekerjaan ini? : <?php echo $row->isi; ?></p>
                           </div>
                           <div class="modal-footer">
                             <button type="submit" class="btn btn-primary" name="submit">Submit</button>
                             <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                      ...
                      <!--   <div class="span5">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>Input Penjelasan Pekerjaan</h4><span class="tools"><a href="javascript:;" class="icon-chevron-down"></a><a href="javascript:;" class="icon-remove"></a></span></div>
                                <div class="widget-body">
