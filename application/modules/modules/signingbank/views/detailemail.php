 ...
 <div class="row-fluid">
            ...
            <div class='actions'>
                ...
                <a href="#" class="btn box-collapse btn-mini btn-link"><i></i>
                            ...
                            <div class='title'>Pencairan Email</div>
                            <div class='actions'>
                                <a href="#" class="btn box-remove btn-mini btn-link"><i class='icon-remove'></i>
                                </a>
                                <a href="#" class="btn box-collapse btn-mini btn-link"><i></i>
                    ...
                    <?php foreach($tampil_data_signing as $row) { ?>
                       ...
                       <?php echo form_open('signingbank/ubahemail', array('class' => "form-horizontal", 'autocomplete' => 'off', 'role'=>'form')) ?>
                                     <input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$detailpersonalid ?>" class="hidden" />

          <div class="control-group">
            <label class="control-label">Tanggal Pencairan Email </label>
               <div class="controls">
