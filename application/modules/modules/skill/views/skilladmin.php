                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row->mandarin;?></td>
                                             <td><?php echo $row->kategorinya;?></td>
                                              ...
                                              <td>
                                            <a href="#" class="btn btn-mini btn-primary" data-toggle="modal" data-target="#editskill<?php echo $no; ?>"><span>Edit</span></a>  
                                        <a href="#" class="btn btn-mini btn-primary" data-toggle="modal" data-target="#hapusskill<?php echo $no; ?>"><span>Hapus</span></td>
                                            
                                        </tr>

                                         <div class='modal hide fade' id='editskill<?php echo $no; ?>' role='dialog' tabindex='-1'>
                <div class='modal-header'>
                    <button class='close' data-dismiss='modal' type='button'>&times;</button>
                    <h3>UPDATE SKILL</h3>
                </div>  
                <form class="form-horizontal" method="post" action="<?php echo site_url('skill/update_skill'); ?>">
                           <div class="modal-body">
                          ...
                          <input type="hidden" class="form-control" name="id_skill" value="<?php echo $row->id_skill; ?>">
                                          ...
                                          <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select name="kategori" class="span11 " data-placeholder="Choose a Category" tabindex="1">
                                                                        <option value="<?php echo $row->id_skill; ?>" /><?php echo $row->kategorinya; ?>
                                    ...
                                    <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="nama_skill" class="span11 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" value="<?php echo $pilihan->isi;?>" />
                                                            </div>
                                                            </div>
                                    <div class="control-group">
                                                            <label class="control-label">Ketrampilan (Bahasa Taiwan)</label>
                                                            <div class="controls">
                                                                <input type="text" name="nama_skill_taiwan" class="span11 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal Dalam Bahasa Taiwan" data-original-title="Nama Sektor (Bahsa Taiwan)"value="<?php echo $pilihan->mandarin;?>"  />
                                                            </div>
                                                            </div>
