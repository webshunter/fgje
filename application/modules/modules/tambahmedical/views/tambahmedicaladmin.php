...
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$idbiodatanya ?>" class="hidden" />
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="namamedical" class="span7 popovers" data-trigger="hover" data-content="Isi Nama Medical yang di gunakan" data-original-title="Nama Medical" />
                                                            </div>
                                                            </div>
                                                            <div class="control-group">
                                                            <label class="control-label span4">Nomor Medical</label>
                                                            <div class="controls">
                                                                <input type="text" name="nomormedical" class="span7 popovers" data-trigger="hover" data-content="Isi sesuai no medical yang lengkap" data-original-title="Nomor Medical" />
                                                            </div>
                                                            </div>
															  ...
															  <div class="control-group" id="berlaku">
																...
																<div class="controls">
																	<div class=" m-ctrl-medium date-picker span7" data-date="2012-02-22" data-date-format="yyyy.mm.dd" data-date-viewmode="years">
																		<input id="tanggal" class=" m-ctrl-medium date-picker span7" name="tanggal" size="16" data-date-format="yyyy.mm.dd" type="text"  /><span class="add-on"><i class="icon-calendar"></i></span>
																</div>
															</div>
														</div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="kesehatan" class="span7 popovers" data-trigger="hover" data-content="Isi sesuai no medical yang lengkap" data-original-title="Nomor Medical" />
                                                            </div>
                                                            </div>
