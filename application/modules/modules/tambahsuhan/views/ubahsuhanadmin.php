...
<form action="<?php echo site_url('tambahsuhan/ubahsuhandata');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
...
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$idbiodatanya ?>" class="hidden" />
															...
															<div class="control-group hidden" id="berlaku">
