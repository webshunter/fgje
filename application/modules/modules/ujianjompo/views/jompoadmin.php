                ...
                <div class="tabbable tabbable-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_1_3" data-toggle="tab">Rekap Nilai Ujian</a></li>
                    </ul>
                    <div class="tab-content">
                            ...
                            <div class="span5">
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <?php echo form_open('ujianjompo/simpan_data_ujian', array('class' => "form-horizontal", 'autocomplete' => 'off', 'role'=>'form')) ?>
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo site_url('ujianjompo/update_data_ujian/'.$row->id_jenis); ?>" class="btn btn-mini btn-primary" type="button">Ubah</a> 
                                                    <a href="<?php echo site_url('ujianjompo/hapus_data_ujian/'.$row->id_jenis); ?>" class="btn btn-mini" type="button">Hapus</a></td>
                                            </tr>
                                            <?php 
                                            $no++;
                                            } 
                            ...
                            <div class="span5">
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <?php echo form_open('ujianjompo/simpan_data_nilai', array('class' => "form-horizontal", 'autocomplete' => 'off', 'role'=>'form')) ?>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">Gendong (KG)</label>
                                            <div class="controls">
                                                <input type="text" name="gendong" class="span10 popovers">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label">Angkat (KG)</label>
                                            <div class="controls">
                                                <input type="text" name="angkat" class="span10 popovers">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="nilai" class="span10 popovers">
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane" id="tab_1_3">
                            <form class="form-horizontal" method="post" action="<?php echo site_url('ujianjompo/set_detail'); ?>">
