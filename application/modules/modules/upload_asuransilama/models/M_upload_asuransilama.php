...
class M_upload_asuransilama extends CI_Model{
	...
	function simpan_data_asuransilama() {
        ...
        $config['upload_path'] = './assets/uploadasuransilama/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_asuransilama(){
		$sql = "SELECT * FROM upload_asuransilama";
                $query = $this->db->query($sql);
	...
	function hapus_data_asuransilama() {
		$id = $this->input->post('id_asuransilama');
		$this->db->where('id_asuransilama', $id);
		$this->db->delete('upload_asuransilama');
	}
