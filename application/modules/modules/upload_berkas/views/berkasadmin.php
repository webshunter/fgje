    ...
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>Data Upload Surat Tanda Pengambilan Berkas </span>
            </h1>
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Data Upload Surat Tanda Pengambilan Berkas  </li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row-fluid">
            ...
            <div class='title'>Dokumen Surat Tanda Pengambilan Berkas</div>
            <div class='actions'>
...
<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        <?php $no = 1; 
                                                foreach ($tampil_data_berkas as $row) { ?>
                                        <tr>
                                            <td><?php echo $no;?></td>
                                            ...
                                            <td><?php echo $row->penting;?></td>
                                             <td><?php echo $row->cekdokumen;?></td>
                                              <td><?php echo $row->tglterima;?></td>
                                               ...
                                               <td><a href="<?php echo base_url().'/assets/upload_berkas/'.$row->file;?>"><?php echo $row->file;?></td>
 ...
 <div class='modal hide fade' id='edit<?php echo $no; ?>' role='dialog' tabindex='-1'>
                <div class='modal-header'>
                    ...
                    <h3>Update Surat Tanda Pengambilan Berkas</h3>
                </div>  
                <form class="form-horizontal" method="post" action="<?php echo site_url('upload_berkas/update_data_berkas'); ?>">
                       ...
                       <div class="modal-dialog">
                         <div class="modal-content">
                           ...
                           <div class="modal-header">
                             ...
                             <h4 class="modal-title">Hapus Data Surat Tanda Pengambilan Berkas</h4>
                           </div>
                           <div class="modal-body">
                             <input type="hidden" class="form-control" name="id_berkas" value="<?php echo $row->id_berkas; ?>">
...
<div class='modal hide fade' id='tambah' role='dialog' tabindex='-2'>
                <div class='modal-header'>
                    <button class='close' data-dismiss='modal' type='button'>&times;</button>
                    <h3>Tambah Surat Tanda Pengambilan Berkas</h3>
                </div>
                <div class='modal-body'>
