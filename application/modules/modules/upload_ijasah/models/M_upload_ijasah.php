...
class M_upload_ijasah extends CI_Model{
	...
	function simpan_data_ijasah() {
        ...
        $config['upload_path'] = './assets/uploadijasah/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_ijasah(){
		$sql = "SELECT * FROM upload_ijasah";
                $query = $this->db->query($sql);
	...
	function hapus_data_ijasah() {
		$id = $this->input->post('id_ijasah');
		$this->db->where('id_ijasah', $id);
		$this->db->delete('upload_ijasah');
	}
