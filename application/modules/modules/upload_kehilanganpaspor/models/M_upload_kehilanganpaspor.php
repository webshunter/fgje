...
class M_upload_kehilanganpaspor extends CI_Model{
	...
	function simpan_data_kehilanganpaspor() {
        ...
        $config['upload_path'] = './assets/uploadkehilanganpaspor/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_kehilanganpaspor(){
		$sql = "SELECT * FROM upload_kehilanganpaspor";
                $query = $this->db->query($sql);
	...
	function hapus_data_kehilanganpaspor() {
		$id = $this->input->post('id_kehilanganpaspor');
		$this->db->where('id_kehilanganpaspor', $id);
		$this->db->delete('upload_kehilanganpaspor');
	}
