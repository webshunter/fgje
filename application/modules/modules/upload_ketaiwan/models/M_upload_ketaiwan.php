...
class M_upload_ketaiwan extends CI_Model{
	...
	function simpan_data_ketaiwan() {
        ...
        $config['upload_path'] = './assets/uploadketaiwan/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_ketaiwan(){
		$sql = "SELECT * FROM upload_ketaiwan";
                $query = $this->db->query($sql);
	...
	function hapus_data_ketaiwan() {
		$id = $this->input->post('id_ketaiwan');
		$this->db->where('id_ketaiwan', $id);
		$this->db->delete('upload_ketaiwan');
	}
