...
class M_upload_kpapra extends CI_Model{
	...
	function simpan_data_kpapra() {
        ...
        $config['upload_path'] = './assets/uploadkpapra/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_kpapra(){
		$sql = "SELECT * FROM upload_kpapra";
                $query = $this->db->query($sql);
	...
	function hapus_data_kpapra() {
		$id = $this->input->post('id_kpapra');
		$this->db->where('id_kpapra', $id);
		$this->db->delete('upload_kpapra');
	}
