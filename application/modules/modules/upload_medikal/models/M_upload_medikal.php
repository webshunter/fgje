...
class M_upload_medikal extends CI_Model{
	...
	function simpan_data_medikal() {
        ...
        $config['upload_path'] = './assets/uploadmedikal/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_medikal(){
		$sql = "SELECT * FROM upload_medikal";
                $query = $this->db->query($sql);
	...
	function hapus_data_medikal() {
		$id = $this->input->post('id_medikal');
		$this->db->where('id_medikal', $id);
		$this->db->delete('upload_medikal');
	}
