...
class M_upload_medikalfull extends CI_Model{
	...
	function simpan_data_medikalfull() {
        ...
        $config['upload_path'] = './assets/uploadmedikalfull/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_medikalfull(){
		$sql = "SELECT * FROM upload_medikalfull";
                $query = $this->db->query($sql);
	...
	function hapus_data_medikalfull() {
		$id = $this->input->post('id_medikalfull');
		$this->db->where('id_medikalfull', $id);
		$this->db->delete('upload_medikalfull');
	}
