...
class M_upload_perjanjianpenempatan extends CI_Model{
	...
	function simpan_data_perjanjianpenempatan() {
        ...
        $config['upload_path'] = './assets/uploadperjanjianpenempatan/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_perjanjianpenempatan(){
		$sql = "SELECT * FROM upload_perjanjianpenempatan";
                $query = $this->db->query($sql);
	...
	function hapus_data_perjanjianpenempatan() {
		$id = $this->input->post('id_perjanjianpenempatan');
		$this->db->where('id_perjanjianpenempatan', $id);
		$this->db->delete('upload_perjanjianpenempatan');
	}
