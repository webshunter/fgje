...
class M_upload_serkes extends CI_Model{
	...
	function simpan_data_serkes() {
        ...
        $config['upload_path'] = './assets/uploadserkes/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_serkes(){
		$sql = "SELECT * FROM upload_serkes";
                $query = $this->db->query($sql);
	...
	function hapus_data_serkes() {
		$id = $this->input->post('id_serkes');
		$this->db->where('id_serkes', $id);
		$this->db->delete('upload_serkes');
	}
