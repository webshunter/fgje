...
class M_upload_sertifikatujian extends CI_Model{
	...
	function simpan_data_sertifikatujian() {
        ...
        $config['upload_path'] = './assets/uploadsertifikatujian/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_sertifikatujian(){
		$sql = "SELECT * FROM upload_sertifikatujian";
                $query = $this->db->query($sql);
	...
	function hapus_data_sertifikatujian() {
		$id = $this->input->post('id_sertifikatujian');
		$this->db->where('id_sertifikatujian', $id);
		$this->db->delete('upload_sertifikatujian');
	}
