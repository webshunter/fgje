...
function tampil_data_personal($idnya){
	...
	function tampil_data_spernyataan(){
		$sql = "SELECT * FROM upload_spernyataan";
                $query = $this->db->query($sql);
	...
	function hapus_data_spernyataan() {
		$id = $this->input->post('id_spernyataan');
		$this->db->where('id_spernyataan', $id);
		$this->db->delete('upload_spernyataan');
	}
