...
function tampil_data_personal($idnya){
	...
	function tampil_data_suhankabur(){
		$sql = "SELECT * FROM upload_suhankabur";
                $query = $this->db->query($sql);
	...
	function hapus_data_suhankabur() {
		$id = $this->input->post('id_suhankabur');
		$this->db->where('id_suhankabur', $id);
		$this->db->delete('upload_suhankabur');
	}
