...
class M_upload_suratijinkeluarga extends CI_Model{
	...
	function simpan_data_suratijinkeluarga() {
        ...
        $config['upload_path'] = './assets/uploadsuratijinkeluarga/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_suratijinkeluarga(){
		$sql = "SELECT * FROM upload_suratijinkeluarga";
                $query = $this->db->query($sql);
	...
	function hapus_data_suratijinkeluarga() {
		$id = $this->input->post('id_suratijinkeluarga');
		$this->db->where('id_suratijinkeluarga', $id);
		$this->db->delete('upload_suratijinkeluarga');
	}
