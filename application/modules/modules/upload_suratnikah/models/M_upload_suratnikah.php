...
class M_upload_suratnikah extends CI_Model{
	...
	function simpan_data_suratnikah() {
        ...
        $config['upload_path'] = './assets/uploadsuratnikah/'; //path folder
...
function tampil_data_personal($idnya){
	...
	function tampil_data_suratnikah(){
		$sql = "SELECT * FROM upload_suratnikah";
                $query = $this->db->query($sql);
	...
	function hapus_data_suratnikah() {
		$id = $this->input->post('id_suratnikah');
		$this->db->where('id_suratnikah', $id);
		$this->db->delete('upload_suratnikah');
	}
