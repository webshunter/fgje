...
function tampil_data_personal($idnya){
	...
	function tampil_data_visaarrival(){
		$sql = "SELECT * FROM upload_visaarrival";
                $query = $this->db->query($sql);
	...
	function hapus_data_visaarrival() {
		$id = $this->input->post('id_visaarrival');
		$this->db->where('id_visaarrival', $id);
		$this->db->delete('upload_visaarrival');
	}
