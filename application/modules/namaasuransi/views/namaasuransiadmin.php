        ...
        <div class='page-header'>
            ...
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Data Nama Asuransi </li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="alert alert-info">
						...
						<button data-dismiss="alert" class="close"> x </button> Welcome <strong> <?php echo $tampil_nama_user; ?> </strong> PT Flamboyan Gema Jasa 
                          ...
                          <div class='row-fluid'>
    <div class='span12'>
<a class='btn btn-info btn-large' data-toggle='modal' href='#tambahnamaasuransi' role='button'>Tambah Nama Asuransi</a>
...
<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                            <div class='box-header orange-background'>
                                <div class='title'>Data Nama Asuransi</div>
                                <div class='actions'>
                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        <?php $no = 1; 
                                                foreach ($tampil_data_namaasuransi as $row) { ?>
                                        <tr>
                                            <td><?php echo $no;?></td>
 ...
 <div class='modal hide fade' id='edit<?php echo $no; ?>' role='dialog' tabindex='-1'>
                <div class='modal-header'>
                    ...
                    <h3>Update Nama Asuransi</h3>
                </div>  
                <form class="form-horizontal" method="post" action="<?php echo site_url('namaasuransi/update_data_namaasuransi'); ?>">
                           <div class="modal-body">
                           
                          <input type="hidden" class="form-control" name="id_namaasuransi" value="<?php echo $row->id_namaasuransi; ?>">

                                         <div class="control-group">
                                                            <label class="control-label">Nama Asuransi</label>
                                                            <div class="controls">
                                                                <input type="text" name="nama_namaasuransi" class="span10 popovers" value="<?php echo $row->isi; ?>"/>
                                                            </div>
                                                            </div>
 ...
 <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-2" role="dialog">
                       <div class="modal-dialog">
                         <div class="modal-content">
                           <form class="form-horizontal" method="post" action="<?php echo site_url('namaasuransi/hapus_data_namaasuransi'); ?>">
                           <div class="modal-header">
                             <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
                             <h4 class="modal-title">Hapus Data Nama Asuransi</h4>
                           </div>
                           <div class="modal-body">
                             <input type="hidden" class="form-control" name="id_namaasuransi" value="<?php echo $row->id_namaasuransi; ?>">
                              <p>Apakah anda yakin akan menghapus data Nama Asuransi ini? : <?php echo $row->isi; ?></p>
                           </div>
                           <div class="modal-footer">
                             <button type="submit" class="btn btn-primary" name="submit">Submit</button>
                             <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
...
<?php echo form_open('agama/simpan_data_agama', array('class' => "form-horizontal", 'autocomplete' => 'off', 'role'=>'form')) ?>
                              ...
                              <?php echo form_close(); ?>
                                         ...
                                         <div class='modal hide fade' id='tambahnamaasuransi' role='dialog' tabindex='-2'>
                <div class='modal-header'>
                    <button class='close' data-dismiss='modal' type='button'>&times;</button>
                    <h3>Tambah Nama Asuransi</h3>
                </div>
                <div class='modal-body'>
<form action="<?php echo site_url('namaasuransi/simpan_data_namaasuransi');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />

                                 <div class="control-group">
                                                            <label class="control-label">Nama Asuransi</label>
                                                            <div class="controls">
                                                                <input type="text" name="nama_namaasuransi" class="span10 popovers" data-trigger="hover" data-content="Isi sesuai nama misal : Male Formal, Female Formal" data-original-title="Nama Sektor" />
                                                            </div>
                                                            </div>
