                ...
                <div class="col-lg-12">
                    <div class="panel panel-info panel-bordered">
                        ...
                        <div class="panel-heading">
                            <a class='btn btn-warning' data-toggle='modal' href='#tambahagama' role='button'>Tambah Dokumen</a>
                                ...
                                <tbody>
                                    ...
                                    foreach ($tampil_data_detail as $row) { ?>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class='modal-header bg-primary'>
                                                        ...
                                                        <h3>Update Dokumen <br/> <?php echo $tampil_nama_agree;?> </h3>
                                                    </div>  
                                                    <form class="form-horizontal" method="post" action="<?php echo site_url('new_majikans/updatedokumen/'.$id_majikan); ?>">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-control" name="dokumen" data-placeholder="Choose a Category" tabindex="1">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-control" data-placeholder="Choose a Category" tabindex="1" name="stats"  >
                                        ...
                                        <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-2" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form class="form-horizontal" method="post" action="<?php echo site_url('new_majikans/hapusdokumen/'.$id_majikan); ?>">
            ...
            <div class='modal fade' id='tambahagama' role='dialog' tabindex='-2'>
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class='modal-header bg-primary'>
                            <button class='close' data-dismiss='modal' type='button'>&times;</button>
                            <h3>Tambah Dokumen <br/> <?php echo $tampil_nama_agree;?></h3>
                        </div>
                        <form action="<?php echo site_url('new_majikans/simpandokumen/'.$id_majikan);?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                            <div class='modal-body'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select class="form-control" name="dokumen" data-placeholder="Choose a Category" tabindex="1">
                                            <option value="" />
                                            <?php  
                                                foreach ($tampil_data_dok as $pilihan) { 
                                            ?>
                                                <option value="<?php echo $pilihan->isi;?>" /><?php echo $pilihan->isi;?>
                                            <?php
                                                } 
