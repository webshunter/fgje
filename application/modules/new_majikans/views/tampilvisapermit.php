                ...
                <div class="col-lg-12">
                    <div class="panel panel-info panel-bordered">
                        <div class="panel-heading">
                            ...
                            <a class='btn bg-pink' href="<?php echo site_url('new_majikans/tampildatavisapermit/'.$idsuhan.'/'.$kodemajikan.'/'.$kodeagen.'/'.$kodegroup) ?>">Kembali</a>
                            ...
                            <table class=" table table-bordered table-striped" style='margin-bottom:0;' id="fixedeks">
                                ...
                                <tbody>
                                    ...
                                    <div class='modal fade' id='edit<?php echo $no; ?>' role='dialog' tabindex='-1'>
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form class="form-horizontal" method="post" action="<?php echo site_url('new_majikans/update_history_visapermit/'.$idnya.'/'.$idsuhan.'/'.$kodemajikan.'/'.$kodeagen.'/'.$kodegroup); ?>">
                                    ...
                                    <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-2" role="dialog">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form class="form-horizontal" method="post" action="<?php echo site_url('new_majikans/hapus_history_visapermit/'.$idnya.'/'.$idsuhan.'/'.$kodemajikan.'/'.$kodeagen.'/'.$kodegroup); ?>">
                ...
                <div class='modal fade' id='tambahagama' role='dialog' tabindex='-2'>
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class='modal-body'>
                                <form action="<?php echo site_url('new_majikans/simpan_history_visapermit/'.$idnya.'/'.$idsuhan.'/'.$kodemajikan.'/'.$kodeagen.'/'.$kodegroup);?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
