                ...
                <div class="col-lg-12">
                    <div class="panel panel-info panel-bordered">
                        ...
                        <div class="panel-heading">
                            <h5 class="panel-title ">Ubah Agen Majikan<br> </h5><br/>
                            <div class="heading-elements">
                                <ul class="icons-list">
                        ...
                        <div class='panel-body'>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <label class="control-label col-sm-4">Data Grup</label>
                                    <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-2"></div>
                                    <label class="control-label col-sm-4">Data Agen</label>
                                    <div class="col-sm-4">
                            ...
                            <?php echo form_open('new_majikans/ubahagens/',array('class'=>'form-horizontal')); ?>     
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="<?php echo site_url('new_majikans/'); ?>" class="btn btn-danger">Batal</a>
                                </div>
