<div class='row-fluid'>
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>Surat Pengajuan E KTKLN FGJ SURABAYA</span>
            </h1>
                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url(); ?>printdata/cetak12/<?php echo $row->id_ktkln;?>"  class="btn btn-warning">Print</a></td>                                           
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo site_url('pengajuan_ktkln/edit_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                            	<input type="hidden" class="form-control" name="id_ktkln" value="<?php echo $row->id_ktkln; ?>">
                                                    ...
                                                    <div class="control-group">
                                                      ...
                                                      <div class="controls">
                                                        <input type="text" name="kepada_2" class="span10 popovers"  value="<?php echo $row->kepada_2;?>" class="form-control" required>
                                                      </div>
                                                    </div>
                                                  </div>
                                            ...
                                            <div class="modal-body">
                                            	<form action="<?php echo site_url('pengajuan_ktkln/hapus_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                                  <input type="hidden" class="form-control" name="id_ktkln" value="<?php echo $row->id_ktkln; ?>">
                             ...
                             <div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo site_url('pengajuan_ktkln/simpan_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label">Kepada</label>
                                                      <div class="controls">
                                                        <input type="text" name="kepada_2" class="span10 popovers"  placeholder="Isikan Data" class="form-control" required>
                                                      </div>
                                                    </div>
                                                  </div>
                                                <div class="modal-footer">
