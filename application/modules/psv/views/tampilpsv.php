                ...
                <div class="col-lg-12">
                    <div class="panel panel-info panel-bordered">
                        ...
                        <div class="panel-heading">
                            ...
                            <a class='btn bg-pink' href="<?php echo site_url('psv/') ?>">Kembali</a>
                            ...
                            <table class=" table table-bordered table-striped" style='margin-bottom:0;' id="fixedeks">
                                ...
                                <tbody>
                                    ...
                                    <div class='modal fade' id='edit<?php echo $no; ?>' role='dialog' tabindex='-1'>
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form class="form-horizontal" method="post" action="<?php echo site_url('new_suhan/update_history_suhan/'.$idnya); ?>">
                                    ...
                                    <div class="modal fade" id="hapus<?php echo $no; ?>" tabindex="-2" role="dialog">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form class="form-horizontal" method="post" action="<?php echo site_url('new_suhan/hapus_history_suhan/'.$idnya); ?>">
                ...
                <div class='modal fade' id='tambahagama' role='dialog' tabindex='-2'>
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class='modal-body'>
                                <form action="<?php echo site_url('new_suhan/simpan_history_suhan/'.$idnya);?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
