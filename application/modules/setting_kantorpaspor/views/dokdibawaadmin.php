...
<div class="col-lg-12">
            <h5 class="panel-title text-center ">SETTING KANTOR PASPOR <br> </h5><br/>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info ubah-kategori"
                      data-id = "<?php echo $value->id_setting_kantorpaspor ?>"
                      data-isi = "<?php echo $value->nama; ?>"
                      data-mandarin = "<?php echo $value->alamat; ?>"
                    >ubah</a>
                    <a data-id = "<?php echo $value->id_setting_kantorpaspor ?>" class="btn btn-danger hapus">Hapus</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
...
<form action="<?php echo site_url(); ?>/setting_kantorpaspor/update_data_dokdibawa" method="POST">
...
<form action="<?php echo site_url(); ?>/setting_kantorpaspor/simpan_data_dokdibawa" method="POST">
  ...
  $("body").click(function(e) {
    ...
    if (target.is('.hapus')) {
       var id = target.attr("data-id");
        ...
        if (r == true) {
          location.href = "<?php echo site_url(); ?>/setting_kantorpaspor/hapus_data_dokdibawa/"+id;
        } else {
