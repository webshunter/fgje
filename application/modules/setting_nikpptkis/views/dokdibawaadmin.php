...
<div class="col-lg-12">
            <h5 class="panel-title text-center ">SETTING NIK PPTKIS<br> </h5><br/>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info ubah-kategori"
                      data-id = "<?php echo $value->id_setting_nikpptkis ?>"
                      data-isi1 = "<?php echo $value->nama; ?>"
                      data-isi = "<?php echo $value->nik; ?>"
                    >ubah</a>
                    <a data-id = "<?php echo $value->id_setting_nikpptkis ?>" class="btn btn-danger hapus">Hapus</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
...
<form action="<?php echo site_url(); ?>/setting_nikpptkis/update_data_dokdibawa" method="POST">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
              <label>Nama</label>
              <input style="width: calc(100% - 10px);" type="text" class="form-control" id="isi1" name="nama">
          </div>
          <div class="form-group">
              <label>NIK</label>
...
<form action="<?php echo site_url(); ?>/setting_nikpptkis/simpan_data_dokdibawa" method="POST">
  ...
  $("body").click(function(e) {
    ...
    if (target.is('.hapus')) {
       var id = target.attr("data-id");
        ...
        if (r == true) {
          location.href = "<?php echo site_url(); ?>/setting_nikpptkis/hapus_data_dokdibawa/"+id;
        } else {
