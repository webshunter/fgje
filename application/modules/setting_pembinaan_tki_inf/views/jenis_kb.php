<div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4><span class="text-semibold">Data Jenis KB</span> - TKI</h4>
			</div>

			<div class="heading-elements">
				<div class="heading-btn-group">
					<a href="#" class="btn btn-link btn-float has-text"><i class="icon-people"></i> <span>Data Jenis KB BLK</span></a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="content-wrapper">
					...
					<div class="modal-dialog modal-md">
						<div class="modal-content">
							<div class="modal-header bg-primary">
								...
								<h5 class="modal-title">Tambah Jenis KB </h5>
							</div>
							<form action="<?php echo site_url('setting_pembinaan_tki_inf/simpan_data_jenis_kb'); ?>" class="form-horizontal" method="post">
								<div class="modal-body">
									<div class="form-group">
										<label class="control-label col-sm-3">Kode Jenis KB </label>
										<div class="col-sm-9">
											<input type="text" placeholder="Kode" class="form-control" name="kode_jenis_kb">
										</div>
									</div>
				...
				<div class="panel panel-flat">
					...
					<table class="table datatable-basic table-bordered table-striped table-hover">
						...
						<tbody>
						<?php $no = 1; 
                                    foreach ($tampil_data_jenis_kb as $row) { ?>
							<tr>
								<td><?php echo $no;?></td>
								<td><?php echo $row->kode_jenis_kb;?></td>
							...
							<div id="edit<?php echo $no; ?>" class="modal fade" role="dialog">
								<div class="modal-dialog modal-md">
									<div class="modal-content">
										...
										<div class="modal-body">
										<form action="<?php echo site_url('setting_pembinaan_tki_inf/update_data_jenis_kb'); ?>" class="form-horizontal" method="post">										
											<input type="hidden" class="form-control" name="id_jenis_kb" value="<?php echo $row->id_jenis_kb; ?>">
												<div class="form-group">
													<div class="row">
														<label class="control-label col-sm-3">Kode Jenis KB </label>
														<div class="col-sm-9">
															<input type="text" class="form-control" name="kode_jenis_kb" value="<?php echo $row->kode_jenis_kb; ?>">
														</div>
													</div>
												</div>
												<div class="form-group">
							...
							<div id="hapus<?php echo $no; ?>" class="modal fade" role="dialog">
								<div class="modal-dialog modal-md">
									<div class="modal-content">
										...
										<form action="<?php echo site_url('setting_pembinaan_tki_inf/hapus_data_jenis_kb'); ?>" class="form-horizontal" method="post">										
											<div class="modal-body">
												<input type="hidden" class="form-control" name="id_jenis_kb" value="<?php echo $row->id_jenis_kb; ?>">
