...
<div class="col-lg-12">
            <h5 class="panel-title text-center ">SETTING PENDIDIKAN<br> </h5><br/>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info ubah-kategori"
                      data-id = "<?php echo $value->id_setting_pendidikan ?>"
                      data-k1 = "<?php echo $value->k1; ?>"
                      data-k2 = "<?php echo $value->k2; ?>"
                      data-k3 = "<?php echo $value->k3; ?>"
                    >ubah</a>
                    <a data-id = "<?php echo $value->id_setting_pendidikan ?>" class="btn btn-danger hapus">Hapus</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
...
<form action="<?php echo site_url(); ?>/setting_pendidikan/update_data_dokdibawa" method="POST">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input style="width: calc(100% - 10px);" type="hidden" class="form-control" id="k2" name="k2">
            <input style="width: calc(100% - 10px);" type="hidden" class="form-control" id="k3" name="k3">
      </div>
...
<form action="<?php echo site_url(); ?>/setting_pendidikan/simpan_data_dokdibawa" method="POST">
  ...
  $("body").click(function(e) {
    ...
    if (target.is('.hapus')) {
       var id = target.attr("data-id");
        ...
        if (r == true) {
          location.href = "<?php echo site_url(); ?>/setting_pendidikan/hapus_data_dokdibawa/"+id;
        } else {
