...
<div class="col-lg-12">
            <h5 class="panel-title text-center ">SETTING VAKSIN<br> </h5><br/>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-info ubah-kategori"
                      data-id = "<?php echo $value->id_setting_vaksinlist ?>"
                      data-isi1 = "<?php echo $value->nama; ?>"
                    >ubah</a>
                    <a data-id = "<?php echo $value->id_setting_vaksinlist ?>" class="btn btn-danger hapus">Hapus</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
...
<form action="<?php echo site_url(); ?>/setting_vaksin/update_data_dokdibawa" method="POST">
...
<form action="<?php echo site_url(); ?>/setting_vaksin/simpan_data_dokdibawa" method="POST">
  ...
  $("body").click(function(e) {
    ...
    if (target.is('.hapus')) {
       var id = target.attr("data-id");
        ...
        if (r == true) {
          location.href = "<?php echo site_url(); ?>/setting_vaksin/hapus_data_dokdibawa/"+id;
        } else {
