<div class='row-fluid'>
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>SURAT PERJANJIAN KERJA <strong>Panti Jompo</strong></span>
            </h1>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo site_url('surat_kerja_jompo/edit_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                            ...
                                            <div class="modal-body">
                                            	<form action="<?php echo site_url('surat_kerja_jompo/hapus_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                                  <input type="hidden" class="form-control" name="id_kerja" value="<?php echo $row->id_kerja; ?>">
                                        ...
                                        <div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                            <div class="modal-header">
                                                ...
                                                <h3 id="myModalLabel1">Tambah Data</h3></div>
                                            <div class="modal-body">
                                                <form action="<?php echo site_url('surat_kerja_jompo/simpan_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
