        ...
        <div class='page-header'>
            ...
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Print Surat Perjanjian Penempatan Formal</li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url(); ?>printdata/cetak32/<?php echo $row->id_perjanjian;?>" class="btn btn-warning">Print</a></td>                                           
                                            ...
                                            <div class="modal-body">
                                                <form action="<?php echo site_url('surat_perjanjian_formal/edit_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                            ...
                                            <div class="modal-body">
                                            	<form action="<?php echo site_url('surat_perjanjian_formal/hapus_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
                                                  <input type="hidden" class="form-control" name="id_perjanjian" value="<?php echo $row->id_perjanjian; ?>">
...
<div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                            <div class="modal-header">
                                                ...
                                                <h3 id="myModalLabel1">Tambah Data</h3></div>
                                            <div class="modal-body">
                                                <form action="<?php echo site_url('surat_perjanjian_formal/simpan_data_surat');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
