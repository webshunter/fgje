                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <h3 class="page-title"> Ubah pengalaman Experience <small>Mengubah pengalaman Experience Pendaftar</small></h3>
                        <ul class="breadcrumb">
                            <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Admin</a><span class="divider">&nbsp;</span></li>
                            <li><a href="#">Ubah pengalaman Experience</a><span class="divider-last">&nbsp;</span></li>
...
<div class="row-fluid">
 ...
 <div class="span8">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>Ubah pengalaman EXPERIENCE-工作經驗 </h4><span class="tools"><a href="javascript:;" class="icon-chevron-down"></a><a href="javascript:;" class="icon-remove"></a></span></div>
                                <div class="widget-body">
...
<form action="<?php echo site_url('tambahpengalaman/ubahpengalamandata');?>" enctype="multipart/form-data" method="post" class="form-horizontal" />
 <?php foreach ($tampil_data_pengalamandetail as $row) { ?>
...
<input type="text" id="idpengalaman" name="idpengalaman" value="<?php echo $row->id_pengalaman;?>" class="hidden" />
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="periodekerja" class="span7 popovers" data-trigger="hover" data-content="Isi Periode ex: (2008-20015)" data-original-title="Periode" value="<?php echo $row->periodekerja;?>"/>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="jamkerja" class="span7 popovers" data-trigger="hover" data-content="Isi jam kerja ex: (07.00-21.00)" data-original-title="Jam Kerja" value="<?php echo $row->jamkerja;?>"/>
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <label class="checkbox">
                                                                        <input type="checkbox" name="kerjaprt" value="1" Checked /> </label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                <input type="text" name="rawatbayi" class="control-label span3"  value="<?php echo $row->rawatbayi;?>"/>&nbsp;&nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="rawatanak" class="span3 popovers" data-trigger="hover" data-content="Masukkan Umur orang jompo" data-original-title="Umur" value="<?php echo $row->rawatanak;?>" />
                                                            </div>
                                                            </div>
