	...
	function tambahskill() {
		...
		//echo "".$datanya;
            	 ...
            	 $data = array(  
                    ...
                    'banyakrokok'=> $this->input->post('banyakrokok'),
                    'banyakrabun'=> $this->input->post('banyakrabun'),
                    'tanganbasah'=> htmlspecialchars($this->input->post('tanganbasah')),
                    'idiomatik'=> $this->input->post('idiomatik'),
					'mata2'=> $this->input->post('mata2'),
					'tanganbasahchongyi'=> $this->input->post('tanganbasahchongyi'),
					'operasiket'=> $this->input->post('operasiket'),
                );
