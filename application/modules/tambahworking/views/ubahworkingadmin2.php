...
<input type="text" id="idbiodata" name="idbiodata" value="<?php echo "".$idbiodatanya ?>" class="" />
<input type="text" id="idworking" name="idworking" value="<?php echo $row->id_working;?>" class="" />
...
<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select data-placeholder="Pilih Masa Kerja" name="masakerja" class="chosen span4" tabindex="-1" id="masakerja">
                                    ...
                                    <div class="controls">
                                        ...
                                        <select data-placeholder="Pilih Masa Bulan" name="masabulan" class="chosen span4" tabindex="-1" id="masabulan">
