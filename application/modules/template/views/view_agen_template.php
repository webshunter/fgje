...
<li class=''>
    ...
    <ul class='nav nav-stacked'>
        <li class=''>
            <a href='<?php echo site_url().'/dashboard/dataabsen'; ?>'>
                <i class='icon-caret-right'></i>
                <span>Absensi</span>
            </a>
        </li>
        <li class=''>
            <a href='<?php echo site_url().'/dashboard/dataabsenbiaya'; ?>'>
                <i class='icon-caret-right'></i>
                <span>Absensi + Biaya</span>
            </a>
        </li>
        <li class=''>
            <a href='<?php echo site_url().'/dashboard/dataabsenbiayakat'; ?>'>
                <i class='icon-caret-right'></i>
                <span>Absensi + biaya Per Kategori</span>
            </a>
        </li>
