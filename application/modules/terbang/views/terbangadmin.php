...
<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    <thead>
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>Nama Maskapai</th>
                                            <th>Detail Penerbangan 1</th>
                                            <th>Detail Penerbangan 2</th>
                                               <th>TEMPAT dan Jam Tiba Tujuan</th>
                                              <th>status</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row->detailberangkat1;?></td>
                                             <td><?php echo $row->detailberangkat2;?></td>
 ...
 <div class="control-group">
                                     ...
                                     <div class="control-group">
                                                            <label class="control-label">Detail Penerbangan 1</label>
                                                            <div class="controls">
                                                                <input type="text" name="detailberangkat1" value="<?php echo $row->detailberangkat1; ?>" class="span10 popovers" data-trigger="hover" data-content="Isi Dengan format dari ke ex=(China Airlines)" data-original-title="Nama Maskapai" />
                                                            </div>
                                                            </div> 
                                     ...
                                     <div class="control-group">
                                                            <label class="control-label">Detail Penerbangan 2 (Jika Ada)</label>
                                                            <div class="controls">
                                                                <input type="text" name="detailberangkat2" value="<?php echo $row->detailberangkat2; ?>" class="span10 popovers" data-trigger="hover" data-content="Isi Dengan format dari ke ex=(China Airlines)" data-original-title="Nama Maskapai" />
                                                            </div>
                                                            </div> 
...
<div class="control-group">
                                                            <label class="control-label">TEMPAT dan Jam Tiba Tujuan</label>
                                                            <div class="controls">
...
<div id="satupenerbangan">
                                    <div class="control-group">
                                                            <label class="control-label">Detail Penerbangan 1</label>
                                                            <div class="controls">
                                                                <input type="text" name="detailberangkat1" class="span10 popovers" data-trigger="hover" data-content="Isi Dengan format dari ke ex=(JT 654)" data-original-title="Kode Terbang" />
                                                            </div>
                                                            </div>
...
<div id="duapenerbangan">
                                     ...
                                     <div class="control-group">
                                                            <label class="control-label">Detail Penerbangan 2</label>
                                                            <div class="controls">
                                                                <input type="text" name="detailberangkat2" class="span10 popovers" data-trigger="hover" data-content="Isi Dengan format dari ke ex=(JT 654)" data-original-title="Kode Terbang" />
                                                            </div>
                                                            </div>
