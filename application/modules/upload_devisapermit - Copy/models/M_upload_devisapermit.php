...
class M_upload_devisapermit extends CI_Model{
	...
	function simpan_data_devisapermit() {
        ...
        {
            	 $data = array(
            	 	'id_visapermit'=>$this->input->post('idbiodata'),
...
function tampil_data_personal($idnya){
	...
	function tampil_data_devisapermit($idnya){
		$sql = "SELECT * FROM upload_devisapermit WHERE id_visapermit='".$idnya."'";
                $query = $this->db->query($sql);
	...
	function hapus_data_devisapermit() {
		$id = $this->input->post('id_devisapermit');
		$this->db->where('id_devisapermit', $id);
		$this->db->delete('upload_devisapermit');
	}
