<?php
class M_upload_keterangan extends CI_Model{
	...
	function simpan_data_keterangan() {
        ...
        $config['upload_path'] = './assets/upload_keterangan/'; //path folder
		...
		if(empty($_FILES['filenya']['name']))
        {
			...
			$this->db->insert('upload_keterangan', $data);
...
function tampil_data_personal($idnya){
	...
	function update_data_keterangan() {
		...
		$this->db->update('upload_keterangan', $data);
	...
	function hapus_data_keterangan() {
		...
		$this->db->delete('upload_keterangan');
	}
