...
<div class="dropzone">
<a type="button" class="btn" href="<?php echo base_url()."index.php/upload_legal/"?>"><i class=" icon-remove"></i> Kembali </a>
...
url: "<?php echo base_url('index.php/upload_legal/proses_upload') ?>",
maxFilesize: 2,
method:"post",
...
foto_upload.on("removedfile",function(a){
    ...
    $.ajax({
        type:"post",
        data:{token:token},
        url:"<?php echo base_url('index.php/upload_legal/remove_foto') ?>",
        cache:false,
        dataType: 'json',
        success: function(){
