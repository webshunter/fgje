    ...
    <div class='span12'>
        <div class='page-header'>
            <h1 class='pull-left'>
                <i class='icon-star'></i>
                <span>Data Upload Foto Surat Ijin Keluarga </span>
            </h1>
            <div class='pull-right'>
                <ul class='breadcrumb'>
                    ...
                    <li class='active'>Data Upload Foto Surat Ijin Keluarga  </li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row-fluid">
            ...
            <div class='title'>Dokumen Surat Ijin Keluarga</div>
            <div class='actions'>
...
<div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
                            ...
                            <table class='data-table table table-bordered table-striped' style='margin-bottom:0;'>
                                    ...
                                    <tbody>
                                        <?php $no = 1; 
                                                foreach ($tampil_data_suratijinkeluarga as $row) { ?>
                                        <tr>
                                            <td><?php echo $no;?></td>
                                            ...
                                            <td><?php echo $row->penting;?></td>
                                             <td><?php echo $row->cekdokumen;?></td>
                                              <td><?php echo $row->tglterima;?></td>
                                               ...
                                               <td><a href="<?php echo base_url().'/assets/uploadsuratijinkeluarga/'.$row->file;?>"><?php echo $row->file;?></td>
 ...
 <div class='modal hide fade' id='edit<?php echo $no; ?>' role='dialog' tabindex='-1'>
                <div class='modal-header'>
                    ...
                    <h3>Update suratijinkeluarga</h3>
                </div>  
                <form class="form-horizontal" method="post" action="<?php echo site_url('upload_suratijinkeluarga/update_data_suratijinkeluarga'); ?>">
