<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ubah alumni</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= site_url('admin/alumni/update') ?>" method="post" enctype="multipart/form-data">
                        
        <?=
            form::input([
                "type" => "hidden",
                "fc" => "id_alumni",
                "value" => $form_data->id_alumni,
            ])
        ?>
                ...
                <?=
                    form::input([
                        ...
                        "type" => "text",
                        "fc" => "id_pilihan",
                        "placeholder" => "tambahkan id_pilihan",
                        "value" => $form_data->id_pilihan,
                    ])
                ?>
                ...
                <?=
                    form::input([
                        ...
                        "type" => "text",
                        "fc" => "id_tempat",
                        "placeholder" => "tambahkan id_tempat",
                        "value" => $form_data->id_tempat,
                    ])
                ?>
                ...
                ?>
                        ...
                        <div class="form-group">
                          ...
                          <a class="btn btn-default" href="<?= site_url('admin/alumni'); ?>">Back</a>
                        </div>
                    </form>
                </div>
            </div>
