<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ubah blk_data_pengeluaran_delete_history</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= site_url('admin/blk_data_pengeluaran_delete_history/update') ?>" method="post" enctype="multipart/form-data">
                        
        <?=
            form::input([
                "type" => "hidden",
                "fc" => "id_data_pengeluaran",
                "value" => $form_data->id_data_pengeluaran,
            ])
        ?>
                ...
                <?=
                    form::input([
                        ...
                        "value" => $form_data->tipe_pengeluaran,
                    ])
                ?>
                ...
                <?=
                    form::input([
                        ...
                        "value" => $form_data->nominal_pengeluaran,
                    ])
                ?>
                ...
                <?=
                    form::input([
                        ...
                        "value" => $form_data->tanggal_pengeluaran,
                    ])
                ?>
                ...
                <?=
                    form::input([
                        "title" => "pengeluaran_id",
                        "type" => "text",
                        "fc" => "pengeluaran_id",
                        "placeholder" => "tambahkan pengeluaran_id",
                        "value" => $form_data->pengeluaran_id,
                    ])
                ?>
                ...
                ?>
                        ...
                        <div class="form-group">
                          ...
                          <a class="btn btn-default" href="<?= site_url('admin/blk_data_pengeluaran_delete_history'); ?>">Back</a>
                        </div>
                    </form>
                </div>
            </div>
