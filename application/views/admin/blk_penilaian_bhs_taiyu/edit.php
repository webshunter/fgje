<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ubah blk_penilaian_bhs_taiyu</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= site_url('admin/blk_penilaian_bhs_taiyu/update') ?>" method="post" enctype="multipart/form-data">
                        
        <?=
            form::input([
                "type" => "hidden",
                "fc" => "id_penilaian_bhs_taiyu",
                "value" => $form_data->id_penilaian_bhs_taiyu,
            ])
        ?>
                ...
                <?=
                    form::input([
                        ...
                        "type" => "text",
                        "fc" => "bhs_taiyu_id",
                        "placeholder" => "tambahkan bhs_taiyu_id",
                        "value" => $form_data->bhs_taiyu_id,
                    ])
                ?>
                ...
                ?>
                        ...
                        <div class="form-group">
                          ...
                          <a class="btn btn-default" href="<?= site_url('admin/blk_penilaian_bhs_taiyu'); ?>">Back</a>
                        </div>
                    </form>
                </div>
            </div>
