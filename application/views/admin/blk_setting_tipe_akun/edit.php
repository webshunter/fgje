<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ubah blk_setting_tipe_akun</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= site_url('admin/blk_setting_tipe_akun/update') ?>" method="post" enctype="multipart/form-data">
                        
        <?=
            form::input([
                "type" => "hidden",
                "fc" => "id_tipe_akun",
                "value" => $form_data->id_tipe_akun,
            ])
        ?>
                ...
                <?=
                    form::input([
                        ...
                        "type" => "text",
                        "fc" => "id_tipe_akun",
                        "placeholder" => "tambahkan id_tipe_akun",
                        "value" => $form_data->id_tipe_akun,
                    ])
                ?>
                ...
                <?=
                    form::input([
                        "title" => "nama_tipe_akun",
                        "type" => "text",
                        "fc" => "nama_tipe_akun",
                        "placeholder" => "tambahkan nama_tipe_akun",
                        "value" => $form_data->nama_tipe_akun,
                    ])
                ?>
                ...
                ?>
                        ...
                        <div class="form-group">
                          ...
                          <a class="btn btn-default" href="<?= site_url('admin/blk_setting_tipe_akun'); ?>">Back</a>
                        </div>
                    </form>
                </div>
            </div>
