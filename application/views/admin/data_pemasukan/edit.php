<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ubah data_pemasukan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= site_url('admin/data_pemasukan/update') ?>" method="post" enctype="multipart/form-data">
        ...
        ?>
                ...
                ?>
                        ...
                        <div class="form-group">
                          ...
                          <a class="btn btn-default" href="<?= site_url('admin/data_pemasukan'); ?>">Back</a>
                        </div>
                    </form>
                </div>
            </div>
