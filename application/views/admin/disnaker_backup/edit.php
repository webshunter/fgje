<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">Ubah disnaker_backup</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= site_url('admin/disnaker_backup/update') ?>" method="post" enctype="multipart/form-data">
        ...
        ?>
                ...
                <?=
                    form::input([
                        ...
                        "type" => "text",
                        "fc" => "ztipe",
                        "placeholder" => "tambahkan ztipe",
                        "value" => $form_data->ztipe,
                    ])
                ?>
                ...
                ?>
                        ...
                        <div class="form-group">
                          ...
                          <a class="btn btn-default" href="<?= site_url('admin/disnaker_backup'); ?>">Back</a>
                        </div>
                    </form>
                </div>
            </div>
